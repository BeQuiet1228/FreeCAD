...
#include "ui_TargetItem.h"
TargetItem::TargetItem(QWidget* parent /*= 0*/)
	:ui(new Ui::TargetItem())
{
	ui->setupUi(this);
...
void TargetItem::loadTarget(TargetTime* target)
{
...
TargetTime* TargetItem::GenerateTarget()
{
	TargetTime* target;
...
void TargetItem::saveXml(pugi::xml_node node)
{
...
void TargetItem::loadXml(pugi::xml_node node)
{
...
void TargetItem::currentIndexChange(int index)
{
	if (index == 0)
	{
