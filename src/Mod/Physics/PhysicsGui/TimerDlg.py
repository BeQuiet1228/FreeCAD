...
class Ui_TimerDlg(object):
    def setupUi(self, TimerDlg):
        TimerDlg.setObjectName("TimerDlg")
        TimerDlg.resize(367, 355)
        TimerDlg.setModal(False)
        self.buttonBox = QtGui.QDialogButtonBox(TimerDlg)
        self.buttonBox.setGeometry(QtCore.QRect(0, 290, 341, 32))
        self.buttonBox.setOrientation(QtCore.Qt.Horizontal)
        self.buttonBox.setStandardButtons(QtGui.QDialogButtonBox.Cancel|QtGui.QDialogButtonBox.Ok)
        self.buttonBox.setObjectName("buttonBox")
        self.formLayoutWidget = QtGui.QWidget(TimerDlg)
        ...
        self.formLayoutWidget_2 = QtGui.QWidget(TimerDlg)
        ...
        self.verticalLayoutWidget = QtGui.QWidget(TimerDlg)
        ...
        self.retranslateUi(TimerDlg)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL("accepted()"), TimerDlg.accept)
        QtCore.QObject.connect(self.buttonBox, QtCore.SIGNAL("rejected()"), TimerDlg.reject)
        QtCore.QMetaObject.connectSlotsByName(TimerDlg)

    def retranslateUi(self, TimerDlg):
        TimerDlg.setWindowTitle(QtGui.QApplication.translate("TimerDlg", "定时器", None, QtGui.QApplication.UnicodeUTF8))
        self.nameLabel.setText(QtGui.QApplication.translate("TimerDlg", "名称", None, QtGui.QApplication.UnicodeUTF8))
        self.nameLineEdit.setText(QtGui.QApplication.translate("TimerDlg", "DefTimer", None, QtGui.QApplication.UnicodeUTF8))
        self.typeLabel.setText(QtGui.QApplication.translate("TimerDlg", "类型", None, QtGui.QApplication.UnicodeUTF8))
        self.typeComboBox.setItemText(0, QtGui.QApplication.translate("TimerDlg", "周期型", None, QtGui.QApplication.UnicodeUTF8))
        self.typeComboBox.setItemText(1, QtGui.QApplication.translate("TimerDlg", "离散型", None, QtGui.QApplication.UnicodeUTF8))
        self.label_setTime.setText(QtGui.QApplication.translate("TimerDlg", "定时基准", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButton_step.setText(QtGui.QApplication.translate("TimerDlg", "按时间步数", None, QtGui.QApplication.UnicodeUTF8))
        self.radioButton_simulate.setText(QtGui.QApplication.translate("TimerDlg", "按模拟时间", None, QtGui.QApplication.UnicodeUTF8))
        self.label_start.setText(QtGui.QApplication.translate("TimerDlg", "起始时刻", None, QtGui.QApplication.UnicodeUTF8))
        self.label_end.setText(QtGui.QApplication.translate("TimerDlg", "结束时刻", None, QtGui.QApplication.UnicodeUTF8))
        self.label_period.setText(QtGui.QApplication.translate("TimerDlg", "定时周期", None, QtGui.QApplication.UnicodeUTF8))
