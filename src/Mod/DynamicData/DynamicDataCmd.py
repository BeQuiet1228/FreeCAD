...
class DynamicDataAddPropertyCommandClass(object):
    ...
    def Activated(self):
        ...
        FreeCAD.Console.PrintMessage("Item:   "+str(items)+"\n")
        pg = FreeCAD.ParamGet("User parameter:BaseApp/Preferences/Mod/DynamicData")
        ...
        if not ok:
            ...
            # FreeCAD.Console.PrintMessage("mostRecentTypes1   "+str(self.mostRecentTypes))
            ...
            # FreeCAD.Console.PrintMessage("mostRecentTypes2   "+str(self.mostRecentTypes))
...
Current group name: '+str(self.groupName)+'\n')
            ...
            cap = lambda x: x[0] + x[1:] #credit: PradyJord from stackoverflow for this trick
            ...
            # m3dFile.addOrUpdateParameter('dd'+self.propertyName,)
            FreeCAD.Console.PrintMessage('App::Property'+item+self.propertyName+str(self.groupName)+self.tooltip+"\n")
            # end
            if hasVal and len(vals)==0:
                ...
                try:
                    # 输出文件到m3d
                    # m3dFile= M3DFileUtil.M3DFileUtil()
                    # m3dFile.addOrUpdateParameter('dd'+self.propertyName,atr)
                    # m3dFile.addOrUpdateParameter(self.propertyName,atr)
                    # end
                ...
                try:
                    ...
                    setattr(p,self.propertyName,vals)
                except:
                ...
                # didn't has a value
                # m3dFile= M3DFileUtil.M3DFileUtil()
                # m3dFile.addOrUpdateParameter('dd'+self.propertyName,0.0)
                # m3dFile.addOrUpdateParameter(self.propertyName,0.0)
