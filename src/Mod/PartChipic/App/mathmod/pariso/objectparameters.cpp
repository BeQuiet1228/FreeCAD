...
ObjectParameters::~ObjectParameters() {
	delete []objectproperties.ArrayNorVer_localPt;
	delete []objectproperties.ArrayNorVerExtra_localPt;
	delete[]objectproperties.PolyIndices_localPt;
	delete[]objectproperties.PolyIndices_localPtMin;
	delete[]objectproperties.BorderPoints;
	delete[]objectproperties.Typetriangles;
	delete[]objectproperties.WichPointVerifyCond;

	delete[]objectproperties.IsoColorliste;
	delete[]objectproperties.ParColorliste;
	delete[]objectproperties.FillIsoliste;
	delete[]objectproperties.FillParliste;
	delete[]objectproperties.CNDverifyIsoliste;
	delete[]objectproperties.CNDverifyParliste;
	delete[]objectproperties.CNDnotverifyIsoliste;
	delete[]objectproperties.CNDnotverifyParliste;

	delete[]objectproperties.frontcols;
	delete[]objectproperties.backcols;
	delete[]objectproperties.frontcolsPar;
	delete[]objectproperties.backcolsPar;

	delete[]objectproperties.componentsinfos.IsoPositions;
	delete[]objectproperties.componentsinfos.IsoPts;
	delete[]objectproperties.componentsinfos.Parametricpositions;
	delete[]objectproperties.componentsinfos.ParPts;

	delete[]componentsStr.IsoPositions;
	delete[]componentsStr.IsoPts;
	delete[]componentsStr.Parametricpositions;
	delete[]componentsStr.ParPts;
}