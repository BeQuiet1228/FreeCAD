...
int main(int argc, char *argv[])
{
    ...
    QObject::connect( drawingopt.MathmodRef->ui.glWidget->IsoObjetThread->IsoObjet->masterthread, SIGNAL(mySignal(int)), &drawingopt, SLOT(CalculateProgress(int)));
    ...
    {
       drawingopt.setHidden(true);
        mm.setHidden(true);
        drawingopt.LoadNewFileModels(Parameters.autoFilePath,true);
        //drawingopt.ExportObj(Parameters.autoFilePath.replace(".json",".obj"));
