...
#
# Created: Tue Apr 27 12:01:49 2021
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_2.addWidget(self.create2DButton, 2, 0, 1, 1)
        self.create3DTextButton = QtGui.QPushButton(Form)
        self.create3DTextButton.setObjectName("create3DTextButton")
        self.gridLayout_2.addWidget(self.create3DTextButton, 4, 0, 1, 1)
        self.create2DTextButton = QtGui.QPushButton(Form)
        self.create2DTextButton.setObjectName("create2DTextButton")
        self.gridLayout_2.addWidget(self.create2DTextButton, 5, 0, 1, 1)
        self.create3DButton = QtGui.QPushButton(Form)
        self.create3DButton.setObjectName("create3DButton")
        self.gridLayout_2.addWidget(self.create3DButton, 1, 0, 1, 1)
        self.createNew3DButton = QtGui.QPushButton(Form)
        self.createNew3DButton.setObjectName("createNew3DButton")
        self.gridLayout_2.addWidget(self.createNew3DButton, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.createNew3DButton.setText(QtGui.QApplication.translate("Form", "Create 3D Doucment", None, QtGui.QApplication.UnicodeUTF8))
