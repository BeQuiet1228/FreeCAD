...
class showParallelepipedalDialog(showObjDialog):
    def __init__(self, obj, parent=None):
        #手动调用父类构造函数。
        showObjDialog.__init__(self,obj,parent)
        #设置ui文件
        self.ui = ParallelepipedalDialog.Ui_Dialog()
        ...
        if FreeCAD.ActiveDocument.CoordinateSystem=="Rectangular":
            ...
            try:
                if point_1_x_after[1]==2:
                    self.obj.setExpression('Point_0.x',point_1_x_after[0])
                else:
                    self.obj.setExpression('Point_0.x',None)
                    self.obj.Point_0.x = point_1_x_after[0]
            except:
                self.error=self.error+'Point_0.x'+'  '+str(point_1_x_before)+'\n'
            ...
            try:
                if point_1_y_after[1]==2:
                    self.obj.setExpression('Point_0.y',point_1_y_after[0])
                else:
                    self.obj.setExpression('Point_0.y',None)
                    self.obj.Point_0.y=point_1_y_after[0]
            except:
                self.error=self.error+'Point_0.y'+'  '+str(point_1_y_before)+'\n'
            ...
            try:
                if point_1_z_after[1]==2:
                    self.obj.setExpression('Point_0.z',point_1_z_after[0])
                else:
                    self.obj.setExpression('Point_0.z',None)
                    self.obj.Point_0.z=point_1_z_after[0]
            except:
                self.error=self.error+'Point_0.z'+'  '+str(point_1_z_before)+'\n'
            ...
            try:
                if point_2_x_after[1]==2:
                    self.obj.setExpression('Point_1.x',point_2_x_after[0])
                else:
                    self.obj.setExpression('Point_1.x',None)
                    self.obj.Point_1.x=point_2_x_after[0]
            except:
                self.error=self.error+'Point_1.x'+'  '+str(point_2_x_before)+'\n'
            ...
            try:
                if point_2_y_after[1]==2:
                    self.obj.setExpression('Point_1.y',point_2_y_after[0])
                else:
                    self.obj.setExpression('Point_1.y',None)
                    self.obj.Point_1.y=point_2_y_after[0]
            except:
                self.error=self.error+'Point_1.y'+'  '+str(point_2_y_before)+'\n'
            ...
            try:
                if point_2_z_after[1]==2:
                    self.obj.setExpression('Point_1.z',point_2_z_after[0])
                else:
                    self.obj.setExpression('Point_1.z',None)
                    self.obj.Point_1.z=point_2_z_after[0]
            except:
                self.error=self.error+'Point_1.z'+'  '+str(point_2_z_before)+'\n'
            ...
            try:
                if point_3_x_after[1]==2:
                    self.obj.setExpression('Point_2.x',point_3_x_after[0])
                else:
                    self.obj.setExpression('Point_2.x',None)
                    self.obj.Point_2.x=point_3_x_after[0]
            except:
                self.error=self.error+'Point_2.x'+'  '+str(point_3_x_before)+'\n'
            ...
            try:
                if point_3_y_after[1]==2:
                    self.obj.setExpression('Point_2.y',point_3_y_after[0])
                else:
                    self.obj.setExpression('Point_2.y',None)
                    self.obj.Point_2.y=point_3_y_after[0]
            except:
                self.error=self.error+'Point_2.y'+'  '+str(point_3_y_before)+'\n'
            ...
            try:
                if point_3_z_after[1]==2:
                    self.obj.setExpression('Point_2.z',point_3_z_after[0])
                else:
                    self.obj.setExpression('Point_2.z',None)
                    self.obj.Point_2.z=point_3_z_after[0]
            except:
                self.error=self.error+'Point_2.z'+'  '+str(point_3_z_before)+'\n'
            ...
            try:
                if point_4_x_after[1]==2:
                    self.obj.setExpression('Point_3.x',point_4_x_after[0])
                else:
                    self.obj.setExpression('Point_3.x',None)
                    self.obj.Point_3.x=point_4_x_after[0]
            except:
                self.error=self.error+'Point_3.x'+'  '+str(point_4_x_before)+'\n'
            ...
            try:
                if point_4_y_after[1]==2:
                    self.obj.setExpression('Point_3.y',point_4_y_after[0])
                else:
                    self.obj.setExpression('Point_3.y',None)
                    self.obj.Point_3.y=point_4_y_after[0]
            except:
                self.error=self.error+'Point_3.y'+'  '+str(point_4_y_before)+'\n'
            ...
            try:
                if point_4_z_after[1]==2:
                    self.obj.setExpression('Point_3.z',point_4_z_after[0])
                else:
                    self.obj.setExpression('Point_3.z',None)
                    self.obj.Point_3.z=point_4_z_after[0]
            except:
                self.error=self.error+'Point_3.z'+'  '+str(point_4_z_before)+'\n'
            ...
            try:
                ...
                self.error=self.error+'Point_0.R'+'  '+str(point_1_x_before)+'\n'
            ...
            try:
                ...
                self.error=self.error+'Point_0.theta'+'  '+str(point_1_y_before)+'\n'
            ...
            try:
                ...
                self.error=self.error+'Point_1.R'+'  '+str(point_2_x_before)+'\n'
            ...
            try:
                ...
                self.error=self.error+'Point_1.theta'+'  '+str(point_2_y_before)+'\n'
            ...
            try:
                ...
                self.error=self.error+'Point_2.R'+'  '+str(point_3_x_before)+'\n'
            ...
            try:
                ...
                self.error=self.error+'Point_2.theta'+'  '+str(point_3_y_before)+'\n'
            ...
            try:
                ...
                self.error=self.error+'Point_3.R'+'  '+str(point_4_x_before)+'\n'
            ...
            try:
                if point_4_y_after[1]==2:
                    ...
                    self.obj.setExpression('Point_3.y',None)
                    # FreeCAD.Console.PrintMessage('= number test !!!')
                    self.obj.Point_3.y=point_4_y_after[0]
            except:
                self.error=self.error+'Point_3.theta'+'  '+str(point_4_y_before)+'\n'
...
class reshowParallelepipedalDialog(showParallelepipedalDialog):
    def deleteobj(self):
        pass
    ...
    def setDefaultValue(self):
        ...
        if FreeCAD.ActiveDocument.CoordinateSystem=="Rectangular":
            ...
            for i in range(len(list1)):
                if list1[i][0] == 'Point_0.x':
                    str1=list1[i][1].replace('Param.','')
                    list2[0]=str1
                elif list1[i][0] == 'Point_0.y':
                    str1=list1[i][1].replace('Param.','')
                    list2[1]=str1
                elif list1[i][0] == 'Point_0.z':
                    str1=list1[i][1].replace('Param.','')
                    list2[2]=str1
                elif list1[i][0] == 'Point_1.x':
                    str1=list1[i][1].replace('Param.','')
                    list2[3]=str1
            ...
            for x in range(len(list2)):
                if len(list2[x]) == 0:
                    if x == 0:
                        list2[x]=str(ValueUnitslength(self.obj.Point_0.x,length))+length
                    elif x==1:
                        list2[x]=str(ValueUnitslength(self.obj.Point_0.y,length))+length
                    elif x==2:
                        list2[x]=str(ValueUnitslength(self.obj.Point_0.z,length))+length
                    elif x==3:
            ...
            for x in range(len(list2)):
                if len(list2[x]) == 0:
                    if x == 0:
                        ...
                        list2[x]=str(ValueUnitsangle(self.obj.Point_0.y,angle))+angle
                    elif x==2:
                        list2[x]=str(ValueUnitslength(self.obj.Point_0.z,length))+length
                    elif x==3:
                        list2[x]=str(ValueUnitslength(self.obj.Point_1.x,length))+length
