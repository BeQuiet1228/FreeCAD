...
class Pyramid:
    def __init__(self, obj):
        ...
        if self.curCoordinateSystem==CoordinateSystemTools.CoordinateType.Rectangular:
            obj.addProperty("App::PropertyVectorDistance","Point_1","Object of a Pyramid","Corner Point_1 of the Pyramid").Point_1=FreeCAD.Vector(0,0,0)
            obj.addProperty("App::PropertyVectorDistance","Point_2","Object of a Pyramid","Corner Point_2 of the Pyramid").Point_2=FreeCAD.Vector(0.005,0,0)
            obj.addProperty("App::PropertyVectorDistance","Point_3","Object of a Pyramid","Corner Point_3 of the Pyramid").Point_3=FreeCAD.Vector(0.005,0.005,0)
            obj.addProperty("App::PropertyVectorDistance","Point_4","Object of a Pyramid","Corner Point_4 of the Pyramid").Point_4=FreeCAD.Vector(0,0.005,0)
            obj.addProperty("App::PropertyVectorDistance","Point_5","Object of a Pyramid","peak of the Pyramid").Point_5=FreeCAD.Vector(0,0,0.005)
            self.vectorList=[obj.Point_1,obj.Point_2,obj.Point_3,obj.Point_4,obj.Point_5]
        elif self.curCoordinateSystem==CoordinateSystemTools.CoordinateType.Polar:
            obj.addProperty("App::PropertyPolVecDistance","Point_1","Object of a Pyramid","Corner Point_1 of the Pyramid").Point_1=FreeCAD.Vector(0,0,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_2","Object of a Pyramid","Corner Point_2 of the Pyramid").Point_2=FreeCAD.Vector(0.002,30,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_3","Object of a Pyramid","Corner Point_3 of the Pyramid").Point_3=FreeCAD.Vector(0.004,60,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_4","Object of a Pyramid","Corner Point_4 of the Pyramid").Point_4=FreeCAD.Vector(0.003,80,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_5","Object of a Pyramid","peak of the Pyramid").Point_5=FreeCAD.Vector(0.003,45,0.005)
            self.vectorList=[obj.Point_1,obj.Point_2,obj.Point_3,obj.Point_4,obj.Point_5]
        else:
            obj.addProperty("App::PropertyCylinderVecDistance","Point_1","Object of a Pyramid","Corner Point_1 of the Pyramid").Point_1=FreeCAD.Vector(0,0,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_2","Object of a Pyramid","Corner Point_2 of the Pyramid").Point_2=FreeCAD.Vector(0.002,30,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_3","Object of a Pyramid","Corner Point_3 of the Pyramid").Point_3=FreeCAD.Vector(0.004,60,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_4","Object of a Pyramid","Corner Point_4 of the Pyramid").Point_4=FreeCAD.Vector(0.003,80,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_5","Object of a Pyramid","peak of the Pyramid").Point_5=FreeCAD.Vector(0.003,45,0.005)
            self.vectorList=[obj.Point_1,obj.Point_2,obj.Point_3,obj.Point_4,obj.Point_5]
        obj.addProperty("App::PropertyInteger","Order","","Order of the Conformal").Order=100

        ObjectsTools.addPropertyForVol(obj,ObjectsTools.ObjectType.Vol_Pyramid,self.curCoordinateSystem)
        obj.Proxy = self
    ...
    def onChanged(self, fp, prop):
        ...
        if prop=="Point_1" or prop=="Point_2"  or prop=="Point_3"  or prop=="Point_4"  or prop=="Point_5"   :
            if self.flagShape:
                ...
                self.vectorList=[fp.Point_1,fp.Point_2,fp.Point_3,fp.Point_4,fp.Point_5]
                self.flagShape=True
                self.flagPlacement=True
                self.flagExcute=True
    ...
    def redraw(self,fp):
        try:
            ...
            if tempPoint_2==tempPoint_4 and tempPoint_2==tempPoint_3:
                DocumentTools.errorMessage(QtGui.QApplication.translate(
                                            "PyramidInstance",
                                            "tempPoint_3 , tempPoint_2 ,tempPoint_4 cann't be same.",
                                            None))
                return
                pass
            ...
            if tempPoint_3==tempPoint_5 and tempPoint_3==tempPoint_4:
                DocumentTools.errorMessage(QtGui.QApplication.translate(
                                            "PyramidInstance",
                                            "tempPoint_3 , tempPoint_5 ,tempPoint_4 cann't be same.",
                                            None))
                return
                pass
            ...
            front_wire = Part.makePolygon([tempPoint_1, tempPoint_2, tempPoint_5, tempPoint_1])
            back_wire = Part.makePolygon([tempPoint_3, tempPoint_5, tempPoint_4, tempPoint_3])
            left_wire = Part.makePolygon([tempPoint_1, tempPoint_5, tempPoint_4, tempPoint_1])
            right_wire = Part.makePolygon([tempPoint_2, tempPoint_5, tempPoint_3, tempPoint_2])
            bottom_face_left_bottom = Part.makeFace(buttom_wire_left_bottom, "Part::FaceMakerExtrusion")
            buttom_face_right_top = Part.makeFace(buttom_wire_right_top, "Part::FaceMakerExtrusion")
            front_face = Part.makeFace(front_wire, "Part::FaceMakerExtrusion")
            back_face = Part.makeFace(back_wire, "Part::FaceMakerExtrusion")
            ...
            DocumentTools.printErrorMessage("Redraw Pyramid Failed!")
