...
import Units
import PolygonalInstance as Instance
from Modeling.Common.Tools import ObjectsTools

def createPolygonal():
    App.ActiveDocument.openTransaction("Polygonal")
    obj = App.ActiveDocument.addObject("Part::FeaturePython",ObjectsTools.ObjectType.Area_Polygonal)
    Instance.Polygonal(obj)
    Instance.ViewProviderPolygonal(obj.ViewObject)
