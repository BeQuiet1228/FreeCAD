...
class Rhombus:
    def __init__(self, obj):
        ...
        if self.curCoordinateSystem==CoordinateSystemTools.CoordinateType.Rectangular:
            ''' Add some custom properties to our Rhombus feature '''
            obj.addProperty("App::PropertyVectorDistance","Point_1","Object of a Rhombus","Point 1").Point_1=FreeCAD.Vector(0.001,0.001,0)
            obj.addProperty("App::PropertyVectorDistance","Point_2","Object of a Rhombus","Point 2").Point_2=FreeCAD.Vector(0.005,0.005,0)
            obj.addProperty("App::PropertyVectorDistance","Point_3","Object of a Rhombus","Point 3").Point_3=FreeCAD.Vector(0.005,0.005,0.002)
            obj.addProperty("App::PropertyVectorDistance","Point_4","Object of a Rhombus","Point 4").Point_4=FreeCAD.Vector(0.002,0.002,0.002)
            obj.addProperty("App::PropertyVectorDistance","Point_5","Object of a Rhombus","Point 5").Point_5=FreeCAD.Vector(0.002,0.004,0)
            obj.addProperty("App::PropertyVectorDistance","Point_6","Object of a Rhombus","Point 6").Point_6=FreeCAD.Vector(0.006,0.008,0)
            obj.addProperty("App::PropertyVectorDistance","Point_7","Object of a Rhombus","Point 7").Point_7=FreeCAD.Vector(0.004,0.006,0.002)
            obj.addProperty("App::PropertyVectorDistance","Point_8","Object of a Rhombus","Point 8").Point_8=FreeCAD.Vector(0.005,0.005,0.002)

        elif self.curCoordinateSystem==CoordinateSystemTools.CoordinateType.Polar:
            obj.addProperty("App::PropertyPolVecDistance","Point_1","Object of a Rhombus","Point 1").Point_1=FreeCAD.Vector(0.005,30,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_2","Object of a Rhombus","Point 2").Point_2=FreeCAD.Vector(0.004,60,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_3","Object of a Rhombus","Point 3").Point_3=FreeCAD.Vector(0.002,20,0.002)
            obj.addProperty("App::PropertyPolVecDistance","Point_4","Object of a Rhombus","Point 4").Point_4=FreeCAD.Vector(0.001,40,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_5","Object of a Rhombus","Point 5").Point_5=FreeCAD.Vector(0.001,1,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_6","Object of a Rhombus","Point 6").Point_6=FreeCAD.Vector(0.002,1,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_7","Object of a Rhombus","Point 7").Point_7=FreeCAD.Vector(0.002,0.005,0)
            obj.addProperty("App::PropertyPolVecDistance","Point_8","Object of a Rhombus","Point 8").Point_8=FreeCAD.Vector(0.002,0,0.002)
        else:
            obj.addProperty("App::PropertyCylinderVecDistance","Point_1","Object of a Rhombus","Point 1").Point_1=FreeCAD.Vector(0.005,30,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_2","Object of a Rhombus","Point 2").Point_2=FreeCAD.Vector(0.004,60,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_3","Object of a Rhombus","Point 3").Point_3=FreeCAD.Vector(0.002,20,0.002)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_4","Object of a Rhombus","Point 4").Point_4=FreeCAD.Vector(0.001,40,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_5","Object of a Rhombus","Point 5").Point_5=FreeCAD.Vector(0.001,1,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_6","Object of a Rhombus","Point 6").Point_6=FreeCAD.Vector(0.002,1,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_7","Object of a Rhombus","Point 7").Point_7=FreeCAD.Vector(0.002,0.003,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point_8","Object of a Rhombus","Point 8").Point_8=FreeCAD.Vector(0.002,0,0.002)
            # obj.addProperty("App::PropertyVector", "Point_3", "Object of a Rhombus", "Point 3").Point_3 = FreeCAD.Vector(1,40,0)
        self.vectorList=[obj.Point_1,obj.Point_2,obj.Point_3,obj.Point_4,obj.Point_5,obj.Point_6,obj.Point_7,obj.Point_8]
        ObjectsTools.addPropertyForVol(obj,ObjectsTools.ObjectType.Vol_Rhombus,self.curCoordinateSystem)
    ...
    def onChanged(self, fp, prop):
        ...
        if prop=="Label":
            ...
            if self.flagLabel:
                ...
                pass
                self.flagLabel=True
        if  prop == "Point_1" or prop == "Point_2" or prop == "Point_3" or prop == "Point_4" or prop == "Point_5" or prop == "Point_6" or prop == "Point_7" or prop == "Point_8":
            if self.flagShape:
                ...
                self.vectorList=[fp.Point_1,fp.Point_2,fp.Point_3,fp.Point_4,fp.Point_5,fp.Point_6,fp.Point_7,fp.Point_8]
                self.flagShape=True
                self.flagPlacement=True
                self.flagExcute=True
            ...
            if self.flagPlacement:
                ...
                fp.setEditorMode("Point_7",1)
                fp.setEditorMode("Point_8",1)
                #坐标转换
                ...
                fp.Point_7=resultVectors[6]
                fp.Point_8=resultVectors[7]
                self.vectorList=[fp.Point_1,fp.Point_2,fp.Point_3,fp.Point_4,fp.Point_5,fp.Point_6,fp.Point_7,fp.Point_8]
                self.flagPlacement=True
                self.flagShape=True
                self.flagExcute=False
    ...
    def redraw(self,obj):
        try:
            ...
            tempPoint_7=tempPoints[6]
            tempPoint_8=tempPoints[7]


            front_wire_left_bottom = Part.makePolygon([tempPoint_1, tempPoint_2, tempPoint_4, tempPoint_1])
            front_wire_right_top = Part.makePolygon([tempPoint_2, tempPoint_3, tempPoint_4, tempPoint_2])
            
            back_wire_left_bottom = Part.makePolygon([tempPoint_5, tempPoint_7, tempPoint_8, tempPoint_5])
            back_wire_right_top = Part.makePolygon([tempPoint_5, tempPoint_6, tempPoint_7, tempPoint_5])

            buttom_wire_left_bottom = Part.makePolygon([tempPoint_1, tempPoint_2, tempPoint_5, tempPoint_1])
            buttom_wire_right_top = Part.makePolygon([tempPoint_2, tempPoint_5, tempPoint_6, tempPoint_2])

            top_wire_left_top=Part.makePolygon([tempPoint_4, tempPoint_7, tempPoint_8, tempPoint_4])
            top_wire_right_bottom=Part.makePolygon([tempPoint_4, tempPoint_7, tempPoint_3, tempPoint_4])

            left_wire_left_top = Part.makePolygon([tempPoint_8, tempPoint_4, tempPoint_5, tempPoint_8])
            left_wire_right_bottom = Part.makePolygon([tempPoint_1, tempPoint_4, tempPoint_5, tempPoint_1])
            
            right_wire_right_top = Part.makePolygon([tempPoint_7, tempPoint_3, tempPoint_6, tempPoint_7])
            right_wire_left_bottom = Part.makePolygon([tempPoint_2, tempPoint_3, tempPoint_6, tempPoint_2])
            ...
            DocumentTools.printErrorMessage("Redraw Rhombus Failed!")
    ...
    def execute(self, fp):
        ...
        fp.setEditorMode("Point_7",0)
        fp.setEditorMode("Point_8",0)
        if self.flagExcute:
            self.redraw(fp)
            self.flagExcute=False
