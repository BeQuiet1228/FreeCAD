...
class Annular_Section:
    def __init__(self, obj):
        ...
        self.vectorList=[]
        ''' Add some custom properties to our Annular_Section feature '''
        if self.curCoordinateSystem==CoordinateSystemTools.CoordinateType.Rectangular:
            obj.addProperty("App::PropertyVectorDistance","Point1","Object of a Annular_Section","Point1 of the Annular_Section").Point1=FreeCAD.Vector(0.002,0.002,0)
            obj.addProperty("App::PropertyVectorDistance","Point2","Object of a Annular_Section","Point2 of the Annular_Section").Point2=FreeCAD.Vector(0.002,0.002,0.002)
            obj.addProperty("App::PropertyVectorDistance","Point3","Object of a Annular_Section","Point3 of the Annular_Section").Point3=FreeCAD.Vector(0.003,0.003,0)
            obj.addProperty("App::PropertyVectorDistance","Point4","Object of a Annular_Section","Point4 of the Annular_Section").Point4=FreeCAD.Vector(0.001,0.001,0)
            
            obj.addProperty("App::PropertyLength","OuterRadius","Object of a Annular_Section"," Radius of the Annular_Section").OuterRadius=0.002
            obj.addProperty("App::PropertyLength","InnerRadius","Object of a Annular_Section"," Radius of the Annular_Section").InnerRadius=0.001

        elif self.curCoordinateSystem==CoordinateSystemTools.CoordinateType.Polar:
            obj.addProperty("App::PropertyPolVecDistance","Point1","Object of a Annular_Section","Point1 of the Annular_Section").Point1=FreeCAD.Vector(0.002,45,0)
            obj.addProperty("App::PropertyPolVecDistance","Point2","Object of a Annular_Section","Point2 of the Annular_Section").Point2=FreeCAD.Vector(0.002,45,2)
            obj.addProperty("App::PropertyPolVecDistance","Point3","Object of a Annular_Section","Point3 of the Annular_Section").Point3=FreeCAD.Vector(0.003,45,0)
            obj.addProperty("App::PropertyPolVecDistance","Point4","Object of a Annular_Section","Point4 of the Annular_Section").Point4=FreeCAD.Vector(0.001,45,0)
            
            # obj.addProperty("App::PropertyLength","Radius","Object of a Annular_Section","Radius of the Annular_Section").Radius=5.0
            obj.addProperty("App::PropertyLength","OuterRadius","Object of a Annular_Section"," Radius of the Annular_Section").OuterRadius=0.005
            obj.addProperty("App::PropertyLength","InnerRadius","Object of a Annular_Section"," Radius of the Annular_Section").InnerRadius=0.001
        else:
            obj.addProperty("App::PropertyCylinderVecDistance","Point1","Object of a Annular_Section","Point1 of the Annular_Section").Point1=FreeCAD.Vector(0.002,45,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point2","Object of a Annular_Section","Point2 of the Annular_Section").Point2=FreeCAD.Vector(0.002,45,0.002)
            obj.addProperty("App::PropertyCylinderVecDistance","Point3","Object of a Annular_Section","Point3 of the Annular_Section").Point3=FreeCAD.Vector(0.003,45,0)
            obj.addProperty("App::PropertyCylinderVecDistance","Point4","Object of a Annular_Section","Point4 of the Annular_Section").Point4=FreeCAD.Vector(0.001,45,0)
            # obj.addProperty("App::PropertyLength","Radius","Object of a Annular_Section","Radius of the Annular_Section").Radius=5.0
            obj.addProperty("App::PropertyLength","OuterRadius","Object of a Annular_Section"," Radius of the Annular_Section").OuterRadius=0.005
            obj.addProperty("App::PropertyLength","InnerRadius","Object of a Annular_Section"," Radius of the Annular_Section").InnerRadius=0.001
        ...
        ObjectsTools.addPropertyForVol(obj,ObjectsTools.ObjectType.Vol_Annular_Section,self.curCoordinateSystem)
    ...
    def onChanged(self, fp, prop):
        ...
        if prop=="Label":
            ...
            if self.flagLabel:
                ...
                pass
                self.flagLabel=True
        if prop=="Point1" or prop=="Point2" or prop=="Point3" or prop=="Point4" or prop=="InnerRadius" or prop=="OuterRadius" :
            if self.flagShape:
    ...
    def redraw(self,obj):
        ...
        kOuterRadiusRatioVec3=1.0
        kInnerRadiusRatioVec3=0.5
        if not vec3ProjectToPlan.Length==0.0:
            kOuterRadiusRatioVec3=obj.OuterRadius.Value/vec3ProjectToPlan.Length
            kInnerRadiusRatioVec3=obj.InnerRadius.Value/vec3ProjectToPlan.Length


        tempVec3OfRectangle1=kOuterRadiusRatioVec3*vec3ProjectToPlan
        tempVec3OfRectangle2=kInnerRadiusRatioVec3*vec3ProjectToPlan
        vec3OfRectangle1=tempVec3OfRectangle1.add(tempPoint_1)
        vec3OfRectangle2=tempVec3OfRectangle2.add(tempPoint_1)
        # 求出另外上方两个点
        vec3OfRectangle3=vec3OfRectangle2.add(tempPoint_2.sub(tempPoint_1))
        vec3OfRectangle4=vec3OfRectangle1.add(tempPoint_2.sub(tempPoint_1))
        # print "vec3OnArc"+str(vec3OnArc)
        # 求方向点point4与弧线的交点
        vec4ProjectToPlan=vec4Temp.projectToPlane(FreeCAD.Vector(0.0,0.0,0.0),normal)
        # k为原点到弧的交点与VecProjectToPlan长度的比例因子
        kOuterRadiusRatioVec4=1.0
        if not vec4ProjectToPlan.Length==0.0:
            kOuterRadiusRatioVec4=obj.OuterRadius.Value/vec4ProjectToPlan.Length
        tempVec4OfRectangle=kOuterRadiusRatioVec4*vec4ProjectToPlan
        vec4OfRectangle=tempVec4OfRectangle.add(tempPoint_1)



        # 两个向量，原点与端点
        vec3=vec3OfRectangle1.sub(tempPoint_1)

        vec4=vec4OfRectangle.sub(tempPoint_1)
        ...
        try:
            arc=Part.ArcOfCircle(vec3OfRectangle1,vPoint1,vec4OfRectangle)
        ...
        # circle=Part.makeCircle(obj.InnerRadius,vec3OnArc,normalCircle)
        ranctangle=Part.makePolygon([vec3OfRectangle1,vec3OfRectangle2,vec3OfRectangle3,vec3OfRectangle4,vec3OfRectangle1])
        # print str(obj.InnerRadius)+"\n" +str(vec3OnArc)+"\n"+str(normalCircle)
        # circleFace=Part.makeFace([Part.Wire(circle)],"Part::FaceMakerBullseye")
        ranctangleFace=Part.makeFace([Part.Wire(ranctangle)],"Part::FaceMakerBullseye")
        obj.Shape=path.makePipe(ranctangleFace)
    ...
    def execute(self, fp):
        ...
        if self.flagExcute:
            self.redraw(fp)
            self.flagExcute=False
        # FreeCAD.Console.PrintMessage("Recompute Python Annular_Section feature\n")
        # obj = Part.makeAnnular_Section(fp.Radius, fp.Point1)
        # fp.Shape = obj
...
class ViewProviderAnnular_Section:
    def __init__(self, obj):
    ...
    def getIcon(self):
        ...
        return """
            /* XPM */
            static const char * ViewProviderAnnular_Section_xpm[] = {
            "16 16 6 1",
            " 	c None",
            ".	c #141010",
            "+	c #615BD2",
