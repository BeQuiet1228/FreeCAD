...
class VolRevolution:
    def __init__(self, obj):
        ...
        if self.curCoordinateSystem==CoordinateSystemTools.CoordinateType.Rectangular:
            obj.addProperty("App::PropertyVectorDistance", "Point_Base", "Object of a Function", "Length of the box").Point_Base = FreeCAD.Vector(-0.02,-0.02,-0.02)
            obj.addProperty("App::PropertyVectorDistance", "Point_Top", "Object of a Function", "Length of the box").Point_Top = FreeCAD.Vector(0.02,0.02,0.02)
            self.vectorList=[obj.Point_Base,obj.Point_Top]
        # '''极坐标系下的属性面板'''
        elif self.curCoordinateSystem==CoordinateSystemTools.CoordinateType.Polar:
            obj.addProperty("App::PropertyPolVecDistance", "Point_Base", "Object of a Function", "Length of the box").Point_Base = FreeCAD.Vector(-0.01,0,-0.01)
            obj.addProperty("App::PropertyPolVecDistance", "Point_Top", "Object of a Function", "Length of the box").Point_Top = FreeCAD.Vector(0.01,360,0.01)
            self.vectorList=[obj.Point_Base,obj.Point_Top]
        elif self.curCoordinateSystem==CoordinateSystemTools.CoordinateType.Cylindrical:
            obj.addProperty("App::PropertyCylinderVecDistance", "Point_Base", "Object of a Function", "Length of the box").Point_Base = FreeCAD.Vector(0,0,0)
            obj.addProperty("App::PropertyCylinderVecDistance", "Point_Top", "Object of a Function", "Length of the box").Point_Top = FreeCAD.Vector(0.01,0,0)
            self.vectorList=[obj.Point_Base,obj.Point_Top]
        ObjectsTools.addPropertyForVol(obj,ObjectsTools.ObjectType.Vol_Revolution,self.curCoordinateSystem)
