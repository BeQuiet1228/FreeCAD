...
class showRectangularAreaDialog(showObjDialog):
    def __init__(self, obj, parent=None):
        #手动调用父类构造函数。
        showObjDialog.__init__(self,obj,parent)
        #设置ui文件
        self.ui = RectangularAreaDialog.Ui_Dialog()
    ...
    def settheLocation(self):
        ...
        if FreeCAD.ActiveDocument.CoordinateSystem=="Rectangular":
            ...
            pass
class reshowRectangularAreaDialog(showRectangularAreaDialog):
    def deleteobj(self):
        pass
    def setDefaultMark(self):
        mark_x = True
