...
class _Array(_DraftObject):
    ...
    def __init__(self,obj):
        ...
        obj.addProperty("App::PropertyLink","Base","Object of an Array",QT_TRANSLATE_NOOP("App::Property","The base object that must be duplicated"))
        obj.addProperty("App::PropertyEnumeration","ArrayType","Object of an Array",QT_TRANSLATE_NOOP("App::Property","The type of array to create"))
        obj.addProperty("App::PropertyEnumeration", "CenterAxis", "Object of an Array", QT_TRANSLATE_NOOP("App::Property", "The axis of array to rotate"))
        obj.addProperty("App::PropertyEnumeration", "OrthoFace", "Object of an Array", QT_TRANSLATE_NOOP("App::Property", "The face of copies"))
        obj.addProperty("App::PropertyVector","Axis","Object of an Array",QT_TRANSLATE_NOOP("App::Property","The axis direction"))
        obj.addProperty("App::PropertyInteger","NumberX","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Number of copies in X direction"))
        obj.addProperty("App::PropertyInteger","NumberY","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Number of copies in Y direction"))
        obj.addProperty("App::PropertyInteger","NumberZ","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Number of copies in Z direction"))
        obj.addProperty("App::PropertyInteger", "Number", "Object of an Array", QT_TRANSLATE_NOOP("App::Property", "Number of copies in linear"))
        obj.addProperty("App::PropertyInteger","NumberPolar","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Number of copies"))
        obj.addProperty("App::PropertyDistance","IntervalX","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Distance and orientation of intervals in X direction"))
        obj.addProperty("App::PropertyDistance","IntervalY","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Distance and orientation of intervals in Y direction"))
        obj.addProperty("App::PropertyDistance","IntervalZ","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Distance and orientation of intervals in Z direction"))
        ...
        obj.Attribute=[ObjectTools.Attribute.NotDefine,ObjectTools.Attribute.Conductor,ObjectTools.Attribute.Custom,ObjectTools.Attribute.Vacuo]
    ...
    def execute(self,obj):
        ...
        if obj.Base:
            ...
            if obj.ArrayType == "linear":
                ...
                sh = self.linearArray(obj.Base.Shape, obj.IntervalX.Value, obj.IntervalY.Value, obj.IntervalZ.Value, obj.Number)
                ...
                if obj.OrthoFace == "XY":
                    ...
                    sh = self.rectArray(obj.Base.Shape, obj.IntervalX.Value, obj.IntervalY.Value, 0, obj.NumberX, obj.NumberY, 1)
                    ...
                    obj.setEditorMode("IntervalZ", 0)
                    sh = self.rectArray(obj.Base.Shape, obj.IntervalX.Value, 0, obj.IntervalZ.Value, obj.NumberX, 1, obj.NumberZ)
                    ...
                    obj.setEditorMode("IntervalY", 0)
                    obj.setEditorMode("IntervalZ", 0)
                    sh = self.rectArray(obj.Base.Shape, 0, obj.IntervalY.Value, obj.IntervalZ.Value, 1, obj.NumberY, obj.NumberZ)
            else:
...
class _ArrayPolar(_DraftObject):
    ...
    def __init__(self,obj):
        ...
        obj.addProperty("App::PropertyLink","Base","Object of an Array",QT_TRANSLATE_NOOP("App::Property","The base object that must be duplicated"))
        obj.addProperty("App::PropertyEnumeration","ArrayType","Object of an Array",QT_TRANSLATE_NOOP("App::Property","The type of array to create"))
        obj.addProperty("App::PropertyString", "CenterAxis", "Object of an Array", QT_TRANSLATE_NOOP("App::Property", "The axis of array to rotate"))
        obj.addProperty("App::PropertyString", "OrthoFace", "Object of an Array", QT_TRANSLATE_NOOP("App::Property", "The face of copies"))
        obj.addProperty("App::PropertyInteger","NumberR","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Number of copies in R direction"))
        obj.addProperty("App::PropertyInteger","NumberZ","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Number of copies in Z direction"))
        obj.addProperty("App::PropertyInteger", "Number", "Object of an Array",QT_TRANSLATE_NOOP("App::Property", "Number of copies in linear"))
        obj.addProperty("App::PropertyInteger","NumberPolar","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Number of copies"))
        obj.addProperty("App::PropertyDistance","IntervalR","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Distance and orientation of intervals in R direction"))
        obj.addProperty("App::PropertyAngle","IntervalTheta","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Distance and orientation of intervals in Theta direction"))
        obj.addProperty("App::PropertyDistance","IntervalZ","Object of an Array",QT_TRANSLATE_NOOP("App::Property","Distance and orientation of intervals in Z direction"))
        obj.addProperty("App::PropertyString", "Type", "", "Type of Object").Type = ObjectTools.ObjectType.Vol_Array
        obj.addProperty("App::PropertyString", "BaseType", "", "Type of Base Object").BaseType = "BaseType"
        obj.addProperty("App::PropertyInteger", "Order", "", "Order of the Array").Order = 100
        ...
        if obj.Base:
            ...
            if obj.ArrayType == "polar":
                ...
                if obj.ArrayType == "ortho":
                    ...
                    obj.setEditorMode("NumberZ", 2)
                    obj.setEditorMode("OrthoFace", 2)
                    sh = self.linearArray(obj.Base, obj.IntervalR.Value, obj.IntervalTheta.Value, obj.IntervalZ.Value, obj.Number)
            obj.Shape = sh
            if not DraftGeomUtils.isNull(pl):
                obj.Placement = pl
...
class _ArrayCylindrical(_DraftObject):
    ...
    def __init__(self,obj):
        _DraftObject.__init__(self, obj, "Array")
        # print obj.supportedProperties()
        obj.addProperty("App::PropertyLink","Base","Attribute",QT_TRANSLATE_NOOP("App::Property","The base object that must be duplicated"))
        obj.addProperty("App::PropertyEnumeration","ArrayType","Attribute",QT_TRANSLATE_NOOP("App::Property","The type of array to create"))
        obj.addProperty("App::PropertyInteger","NumberR","Attribute",QT_TRANSLATE_NOOP("App::Property","Number of copies in R direction"))
        obj.addProperty("App::PropertyInteger","NumberZ","Attribute",QT_TRANSLATE_NOOP("App::Property","Number of copies in Z direction"))
        obj.addProperty("App::PropertyInteger", "Number", "Attribute",QT_TRANSLATE_NOOP("App::Property", "Number of copies in linear"))
        obj.addProperty("App::PropertyInteger","NumberPolar","Attribute",QT_TRANSLATE_NOOP("App::Property","Number of copies"))
        obj.addProperty("App::PropertyLength","IntervalZ","Attribute",QT_TRANSLATE_NOOP("App::Property","Distance and orientation of intervals in Z direction"))
        obj.addProperty("App::PropertyLength", "IntervalR", "Attribute",QT_TRANSLATE_NOOP("App::Property", "Distance and orientation of intervals in R direction"))
        obj.addProperty("App::PropertyAngle", "IntervalTheta", "Attribute",QT_TRANSLATE_NOOP("App::Property", "Distance and orientation of intervals in Theta direction"))
        obj.addProperty("App::PropertyAngle","Angle","Attribute",QT_TRANSLATE_NOOP("App::Property","Angle to cover with copies"))
        obj.ArrayType = ['linear','ortho','polar']
        obj.NumberR = 1
        obj.NumberZ = 1
        obj.Number = 1
