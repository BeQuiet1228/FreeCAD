...
class OrthographicBody(PartFeature):
    def __init__(self, obj):
        ...
        obj.addProperty("App::PropertyVector","Point_1","OrthographicBodyFace","Length of the box").Point_1=FreeCAD.Vector(0,0,0)
        obj.addProperty("App::PropertyVector","Point_2","OrthographicBodyFace","Length of the box").Point_2=FreeCAD.Vector(1,1,1)
