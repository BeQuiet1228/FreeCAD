...
#
# Created: Fri May 21 16:15:50 2021
...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        Dialog.setTabOrder(self.pb_cancel, self.comboBox_obj)
        Dialog.setTabOrder(self.comboBox_obj, self.comboBox_x)
        Dialog.setTabOrder(self.comboBox_x, self.checkBox_min)
        Dialog.setTabOrder(self.checkBox_min, self.checkBox_mid)
        Dialog.setTabOrder(self.checkBox_mid, self.checkBox_max)
        Dialog.setTabOrder(self.checkBox_max, self.lineEdit_size)
