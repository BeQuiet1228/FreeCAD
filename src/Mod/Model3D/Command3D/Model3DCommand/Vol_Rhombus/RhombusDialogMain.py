...
class ShowDialog(BaseDialogMain.BaseModelDialog):
    ...
    def getInfoFromObj(self):
        ...
        self.pointWidget.ui.lineEdit_point6x.setText(str(self.obj.user_point6_x).replace(' ', ''))
        self.pointWidget.ui.lineEdit_point6y.setText(str(self.obj.user_point6_y).replace(' ', ''))
        self.pointWidget.ui.lineEdit_point6z.setText(str(self.obj.user_point6_z).replace(' ', ''))
        self.pointWidget.ui.lineEdit_point7x.setText(str(self.obj.user_point7_x).replace(' ', ''))
        self.pointWidget.ui.lineEdit_point7y.setText(str(self.obj.user_point7_y).replace(' ', ''))
        self.pointWidget.ui.lineEdit_point7z.setText(str(self.obj.user_point7_z).replace(' ', ''))
        self.pointWidget.ui.lineEdit_point8x.setText(str(self.obj.user_point8_x).replace(' ', ''))
        self.pointWidget.ui.lineEdit_point8y.setText(str(self.obj.user_point8_y).replace(' ', ''))
        self.pointWidget.ui.lineEdit_point8z.setText(str(self.obj.user_point8_z).replace(' ', ''))
    def setInfoToObj(self):
        ...
        self.obj.user_point6_x = self.pointWidget.ui.lineEdit_point6x.text().replace(' ', '')
        self.obj.user_point6_y = self.pointWidget.ui.lineEdit_point6y.text().replace(' ', '')
        self.obj.user_point6_z = self.pointWidget.ui.lineEdit_point6z.text().replace(' ', '')
        self.obj.user_point7_x = self.pointWidget.ui.lineEdit_point7x.text().replace(' ', '')
        self.obj.user_point7_y = self.pointWidget.ui.lineEdit_point7y.text().replace(' ', '')
        self.obj.user_point7_z = self.pointWidget.ui.lineEdit_point7z.text().replace(' ', '')
        self.obj.user_point8_x = self.pointWidget.ui.lineEdit_point8x.text().replace(' ', '')
        self.obj.user_point8_y = self.pointWidget.ui.lineEdit_point8y.text().replace(' ', '')
        self.obj.user_point8_z = self.pointWidget.ui.lineEdit_point8z.text().replace(' ', '')
        ...
        Tools3D.setPlaceToObj(self.obj, "Point6Y", self.pointWidget.ui.lineEdit_point6y.text())
        Tools3D.setPlaceToObj(self.obj, "Point6X", self.pointWidget.ui.lineEdit_point6x.text())
        Tools3D.setPlaceToObj(self.obj, "Point6Z", self.pointWidget.ui.lineEdit_point6z.text())
        Tools3D.setPlaceToObj(self.obj, "Point7Y", self.pointWidget.ui.lineEdit_point7y.text())
        Tools3D.setPlaceToObj(self.obj, "Point7X", self.pointWidget.ui.lineEdit_point7x.text())
        Tools3D.setPlaceToObj(self.obj, "Point7Z", self.pointWidget.ui.lineEdit_point7z.text())
        Tools3D.setPlaceToObj(self.obj, "Point8Y", self.pointWidget.ui.lineEdit_point8y.text())
        Tools3D.setPlaceToObj(self.obj, "Point8X", self.pointWidget.ui.lineEdit_point8x.text())
        Tools3D.setPlaceToObj(self.obj, "Point8Z", self.pointWidget.ui.lineEdit_point8z.text())
        self.obj.recompute()
    ...
    def slotOk(self):
        ...
        if judge:
            QtGui.QMessageBox.information(None, "", "无法有效绘制菱形体，请检查坐标。")
        else:
    ...
    def judgePoint(self):
        ...
        point6 = Tools3D.transToRecVector(self.obj.Point6X.Value, self.obj.Point6Y.Value, self.obj.Point6Z.Value)
        point7 = Tools3D.transToRecVector(self.obj.Point7X.Value, self.obj.Point7Y.Value, self.obj.Point7Z.Value)
        point8 = Tools3D.transToRecVector(self.obj.Point8X.Value, self.obj.Point8Y.Value, self.obj.Point8Z.Value)
        # 判断是否有相等的点
        ...
        if ObjectTools.isPointEqual(point_list):
            return True
        # 判断点是否共面
        elif  not ObjectTools.isFourPointsOnTheSamePlane(front_point1_list):
            return True
        elif not ObjectTools.isFourPointsOnTheSamePlane(back_point_list):
            return True
        elif not ObjectTools.isFourPointsOnTheSamePlane(left_point_list):
            return True
        elif not ObjectTools.isFourPointsOnTheSamePlane(right_point_list):
            return True
        elif not ObjectTools.isFourPointsOnTheSamePlane(top_point_list):
            return True
        elif not ObjectTools.isFourPointsOnTheSamePlane(bottom_point_list):
            return True
        else:
            return False
