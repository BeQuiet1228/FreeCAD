...
class ShowDialog(BaseDialogMain.BaseModelDialog):
    ...
    def setInfoToObj(self):
        ...
        self.obj.Point6X = self.pointWidget.ui.lineEdit_point6x.text()
        self.obj.Point6Y = self.pointWidget.ui.lineEdit_point6y.text()
        self.obj.Point6Z = self.pointWidget.ui.lineEdit_point6z.text()
    ...
    def slotOk(self):
        ...
        if judge:
            QtGui.QMessageBox.information(None, "", "无法有效绘制楔形体，请检查坐标。")
        else:
    ...
    def judgePoint(self):
        ...
        if point1 == point2 and point1 == point4:
            return True
        elif point2 == point4 and point2 == point3:
            return True
        elif point2 == point1 and point2 == point5:
            return True
        elif point3 == point5 and point3 == point4:
            return True
        elif point1 == point5 and point1 == point4:
            return True
        elif point2 == point5 and point3 == point2:
            return True
        elif point2 == point3 and point3 == point6:
            return True
        elif point2 == point5 and point6 == point2:
            return True
        elif point6 == point5 and point3 == point6:
            return True
        elif not ObjectTools.isFourPointsOnTheSamePlane([point1, point2, point3, point4]):
            return True
        else:
            return False
