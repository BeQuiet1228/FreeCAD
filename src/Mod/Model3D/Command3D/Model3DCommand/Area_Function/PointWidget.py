...
#
# Created: Fri Mar  5 17:38:15 2021
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_expression = Completer.AutoCompleteEdit(Form)
        self.lineEdit_expression.setObjectName("lineEdit_expression")
        self.gridLayout.addWidget(self.lineEdit_expression, 3, 1, 1, 3)
        self.label_4 = QtGui.QLabel(Form)
        self.label_4.setObjectName("label_4")
        self.gridLayout.addWidget(self.label_4, 4, 0, 1, 1)
        self.spinBox_precision = QtGui.QSpinBox(Form)
        self.spinBox_precision.setObjectName("spinBox_precision")
        self.gridLayout.addWidget(self.spinBox_precision, 4, 1, 1, 3)
    ...
    def retranslateUi(self, Form):
        ...
        self.label_4.setText(QtGui.QApplication.translate("Form", "Precision:", None, QtGui.QApplication.UnicodeUTF8))
