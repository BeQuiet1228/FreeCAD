...
class ShowDialog(BaseDialogMain.BaseModelDialog):
    ...
    def slotOk(self):
        ...
        if judge:
            QtGui.QMessageBox.information(None, "", "无法有效绘制平行六面体，请检查坐标。")
        else:
    ...
    def judgePoint(self):
        ...
        if Vector_12.Length == 0.0:
            ...
            return True
        elif Vector_12.getAngle(Vector_13) * 180 / math.pi == 0.0 or Vector_12.getAngle(
                Vector_13) * 180 / math.pi == 180.0:
            return True
        elif Vector_12.getAngle(Vector_14) * 180 / math.pi == 0.0 or Vector_12.getAngle(
                Vector_14) * 180 / math.pi == 180.0:
            return True
        elif Vector_13.getAngle(Vector_14) * 180 / math.pi == 0.0 or Vector_13.getAngle(
                Vector_14) * 180 / math.pi == 180.0:
            return True
        elif detValue == 0:
            return True
