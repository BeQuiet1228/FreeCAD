...
class ShowDialog(QtGui.QDialog):
    def __init__(self, obj, isNew=False, parent=None):
        ...
        self.ui = DraftExtrudedDialog.Ui_Dialog()
        self.ui.setupUi(self)
    ...
    def reComboBox(self):
        ...
        area_comformal = ObjectTools.getLabelsByType(ObjectTools.ObjectType.Area_Conformal)
        area_rectangular = ObjectTools.getLabelsByType(ObjectTools.ObjectType.Area_Rectangular)
        areas = area_comformal + area_rectangular
    ...
    def getInfoFromObj(self):
        ...
        self.ui.lineEdit_length.setText(str(self.obj.Length).replace(' ', ''))
    ...
    def setInfoToObj(self):
        ...
        self.obj.Length = self.ui.lineEdit_length.text()
        # 属性
