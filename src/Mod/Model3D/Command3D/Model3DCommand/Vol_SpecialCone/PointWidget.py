...
#
# Created: Fri May 21 15:37:11 2021
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.lineEdit_radiusBottom = Completer.AutoCompleteEdit(Form)
        self.lineEdit_radiusBottom.setObjectName("lineEdit_radiusBottom")
        self.gridLayout.addWidget(self.lineEdit_radiusBottom, 3, 1, 1, 3)
        self.lineEdit_radiusTop = Completer.AutoCompleteEdit(Form)
        self.lineEdit_radiusTop.setObjectName("lineEdit_radiusTop")
        self.gridLayout.addWidget(self.lineEdit_radiusTop, 4, 1, 1, 3)
        ...
        Form.setTabOrder(self.lineEdit_point2z, self.lineEdit_radiusBottom)
        Form.setTabOrder(self.lineEdit_radiusBottom, self.lineEdit_radiusTop)

    def retranslateUi(self, Form):
        Form.setWindowTitle(QtGui.QApplication.translate("Form", "Form", None, QtGui.QApplication.UnicodeUTF8))
        self.label_z2.setText(QtGui.QApplication.translate("Form", "Z", None, QtGui.QApplication.UnicodeUTF8))
        self.label_4.setText(QtGui.QApplication.translate("Form", "PointBottom:", None, QtGui.QApplication.UnicodeUTF8))
        ...
        self.label_6.setText(QtGui.QApplication.translate("Form", "RadiuBottom:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_7.setText(QtGui.QApplication.translate("Form", "RadiuTop:", None, QtGui.QApplication.UnicodeUTF8))
        self.label_5.setText(QtGui.QApplication.translate("Form", "PointTop:", None, QtGui.QApplication.UnicodeUTF8))
