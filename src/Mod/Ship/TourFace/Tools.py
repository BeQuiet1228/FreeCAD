...
import Units
import ToursFaceInstance as Instance


def createTours(solids):
    ...
    """
    obj = App.ActiveDocument.addObject("Part::FeaturePython", "ToursFace")
    ToursFace = Instance.ToursFace(obj, solids)
    Instance.ViewProviderToursFace(obj.ViewObject)
