...
MultiFuse::MultiFuse(void)
{
	...
	ADD_PROPERTY_TYPE(Refine, (0), "Boolean", (App::PropertyType)(App::Prop_None | App::Prop_Hidden), "Refine shape (clean up redundant edges) after this boolean operation");
	/*fubiao*/
	ADD_PROPERTY_TYPE(Order, (100), "Base", (App::PropertyType)(App::Prop_None), "Order of this.");
	ADD_PROPERTY_TYPE(Type, ("Array"), "", (App::PropertyType)(App::Prop_None|App::Prop_Hidden), "");
	ADD_PROPERTY_TYPE(Attribute, (long(0)), "Attribute", (App::PropertyType)(App::Prop_None), "Attribute");
	static const char  *attrs[] = { "NotDefine", "Conductor", "Custom", "Vacuo", NULL };
	Attribute.setEnums(attrs);
