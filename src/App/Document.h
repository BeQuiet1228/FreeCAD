...
public:
	...
	// 使用坐标系
	PropertyString CoordinateSystem;
	//是否需要刷新布尔结果
	PropertyInteger flagNeedUpdateBoolean;
	//存放参数对象变化的参数note:本来想用PropertyStringList来存数据，但是append不起作用
	PropertyString PropertiesChanged;
	PropertyString Begin;
    /// Id e.g. Part number
    PropertyString Id;
