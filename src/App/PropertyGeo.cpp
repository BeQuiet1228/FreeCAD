...
//*@fubiao
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
TYPESYSTEM_SOURCE(App::PropertyPolarVector, App::Property);

PropertyPolarVector::PropertyPolarVector()
{
...
void PropertyPolarVector::setValue(const Base::Vector3d &vec)
{
	aboutToSetValue();
	_cVec = vec;
	hasSetValue();
...
void PropertyPolarVector::setValue(double x, double y, double z)
{
	aboutToSetValue();
	_cVec.Set(x, y, z);
	hasSetValue();
...
const Base::Vector3d & PropertyPolarVector::getValue(void)const
{
	return _cVec;
}

PyObject *PropertyPolarVector::getPyObject(void)
{
	return new Base::VectorPy(_cVec);
}

void PropertyPolarVector::setPyObject(PyObject *value)
{
...
void PropertyPolarVector::Save(Base::Writer &writer) const
{
	writer.Stream() << writer.ind() << "<PropertyPolarVector valueX=\"" << _cVec.x << "\" valueY=\"" << _cVec.y << "\" valueZ=\"" << _cVec.z << "\"/>" << endl;
}

void PropertyPolarVector::Restore(Base::XMLReader &reader)
{
	// read my Element
	reader.readElement("PropertyPolarVector");
...
Property *PropertyPolarVector::Copy(void) const
{
	PropertyPolarVector *p = new PropertyPolarVector();
	p->_cVec = _cVec;
	return p;
}

void PropertyPolarVector::Paste(const Property &from)
{
	aboutToSetValue();
	_cVec = dynamic_cast<const PropertyPolarVector&>(from)._cVec;
	hasSetValue();
}

void PropertyPolarVector::getPaths(std::vector<ObjectIdentifier> &paths) const
{
...
//**************************************************************************
//**************************************************************************
// PropertyCylindricalVector  
//*@fubiao
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
TYPESYSTEM_SOURCE(App::PropertyCylindricalVector, App::Property);

PropertyCylindricalVector::PropertyCylindricalVector()
{
...
void PropertyCylindricalVector::setValue(const Base::Vector3d &vec)
{
	aboutToSetValue();
	_cVec = vec;
	hasSetValue();
...
void PropertyCylindricalVector::setValue(double x, double y, double z)
{
	aboutToSetValue();
	_cVec.Set(x, y, z);
	hasSetValue();
...
const Base::Vector3d & PropertyCylindricalVector::getValue(void)const
{
	return _cVec;
}

PyObject *PropertyCylindricalVector::getPyObject(void)
{
	return new Base::VectorPy(_cVec);
}

void PropertyCylindricalVector::setPyObject(PyObject *value)
{
	if (PyObject_TypeCheck(value, &(Base::VectorPy::Type))) {
		Base::VectorPy  *pcObject = static_cast<Base::VectorPy*>(value);
		Base::Vector3d* val = pcObject->getVectorPtr();
...
void PropertyCylindricalVector::Save(Base::Writer &writer) const
{
	writer.Stream() << writer.ind() << "<PropertyCylindricalVector valueX=\"" << _cVec.x << "\" valueY=\"" << _cVec.y << "\" valueZ=\"" << _cVec.z << "\"/>" << endl;
}

void PropertyCylindricalVector::Restore(Base::XMLReader &reader)
{
	// read my Element
	reader.readElement("PropertyCylindricalVector");
	// get the value of my Attribute
	aboutToSetValue();
	_cVec.x = reader.getAttributeAsFloat("valueX");
	_cVec.y = reader.getAttributeAsFloat("valueY");
...
Property *PropertyCylindricalVector::Copy(void) const
{
	PropertyCylindricalVector *p = new PropertyCylindricalVector();
	p->_cVec = _cVec;
	return p;
}

void PropertyCylindricalVector::Paste(const Property &from)
{
	aboutToSetValue();
	_cVec = dynamic_cast<const PropertyCylindricalVector&>(from)._cVec;
	hasSetValue();
}

void PropertyCylindricalVector::getPaths(std::vector<ObjectIdentifier> &paths) const
{
	paths.push_back(ObjectIdentifier(getContainer()) << ObjectIdentifier::Component::SimpleComponent(getName())
		<< ObjectIdentifier::Component::SimpleComponent(ObjectIdentifier::String("x")));
	paths.push_back(ObjectIdentifier(getContainer()) << ObjectIdentifier::Component::SimpleComponent(getName())
...
/*fubiao*/
//**************************************************************************
// PropertyPolVecDistance
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

TYPESYSTEM_SOURCE(App::PropertyPolVecDistance, App::PropertyPolarVector);

//**************************************************************************
// Construction/Destruction


PropertyPolVecDistance::PropertyPolVecDistance()
{

}

const boost::any PropertyPolVecDistance::getPathValue(const ObjectIdentifier &path) const
{
	std::string p = path.getSubPathStr();
	...
	if (p == ".y"){
		...
		return Base::Quantity(boost::any_cast<double>(Property::getPathValue(path)), Unit::Angle);
	}
	else
		return Property::getPathValue(path);
}
...
//**************************************************************************
// PropertyCylinderVecDistance
//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

TYPESYSTEM_SOURCE(App::PropertyCylinderVecDistance, App::PropertyCylindricalVector);

//**************************************************************************
// Construction/Destruction


PropertyCylinderVecDistance::PropertyCylinderVecDistance()
{

}

const boost::any PropertyCylinderVecDistance::getPathValue(const ObjectIdentifier &path) const
{
	std::string p = path.getSubPathStr();
