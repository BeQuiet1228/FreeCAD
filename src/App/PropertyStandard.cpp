...
//TYPESYSTEM_SOURCE(App::PropertyCheckBox, App::PropertyInteger);
//
////**************************************************************************
//// Construction/Destruction
//
...
//{
//	_editorTypeName = "Gui::PropertyEditor::PropertyCheckBoxItem";
//}
//
//PropertyCheckBox::PropertyCheckBox(const App::Enumeration &e)
//{
//	_enum = e;
//}
//
...
//}
//
//void PropertyCheckBox::setEnums(const char **plEnums)
//{
//	// Setting the enum is done only once inside the constructor
//	// but before the current index is already set. So, this needs
//	// to be preserved.
...
//}
//
//void PropertyCheckBox::setValue(const char *value)
//{
//	aboutToSetValue();
//	_enum.setValue(value);
//	hasSetValue();
//}
//
//void PropertyCheckBox::setValue(long value)
//{
//	aboutToSetValue();
//	_enum.setValue(value);
//	hasSetValue();
//}
//
//void PropertyCheckBox::setValue(const Enumeration &source)
//{
//	aboutToSetValue();
//	_enum = source;
//	hasSetValue();
//}
//
//long PropertyCheckBox::getValue(void) const
//{
//	return _enum.getInt();
//}
//
//bool PropertyCheckBox::isValue(const char *value) const
//{
//	return _enum.isValue(value);
//}
//
//bool PropertyCheckBox::isPartOf(const char *value) const
//{
//	return _enum.contains(value);
//}
//
//const char * PropertyCheckBox::getValueAsString(void) const
//{
//	return _enum.getCStr();
//}
//
//Enumeration PropertyCheckBox::getEnum(void) const
//{
//	return _enum;
//}
//
//std::vector<std::string> PropertyCheckBox::getEnumVector(void) const
//{
//	return _enum.getEnumVector();
//}
//
//const char ** PropertyCheckBox::getEnums(void) const
//{
//	return _enum.getEnums();
//}
//
//void PropertyCheckBox::Save(Base::Writer &writer) const
//{
//	writer.Stream() << writer.ind() << "<Integer value=\"" << _enum.getInt() << "\"";
//	if (_enum.isCustom())
//		writer.Stream() << " CustomEnum=\"true\"";
...
//}
//
//void PropertyCheckBox::Restore(Base::XMLReader &reader)
//{
//	// read my Element
//	reader.readElement("Integer");
//	// get the value of my Attribute
...
//}
//
//PyObject * PropertyCheckBox::getPyObject(void)
//{
//	if (!_enum.isValid()) {
//		PyErr_SetString(PyExc_AssertionError, "The enum is empty");
//		return 0;
...
//}
//
//void PropertyCheckBox::setPyObject(PyObject *value)
//{
//#if PY_MAJOR_VERSION < 3
//	if (PyInt_Check(value)) {
//		long val = PyInt_AsLong(value);
...
//}
//
//Property * PropertyCheckBox::Copy(void) const
//{
//	return new PropertyCheckBox(_enum);
//}
//
//void PropertyCheckBox::Paste(const Property &from)
//{
//	aboutToSetValue();
//
//	const PropertyCheckBox& prop = dynamic_cast<const PropertyCheckBox&>(from);
//	_enum = prop._enum;
//
//	hasSetValue();
//}
//
//void PropertyCheckBox::setPathValue(const ObjectIdentifier &path, const boost::any &value)
//{
//	verifyPath(path);
//
//	if (value.type() == typeid(int))
...
void PropertyFloat::setPathValue(const ObjectIdentifier &path, const boost::any &value)
{
	...
	//	std::cout << "0" << std::endl;
	//if (boost::any_cast<Quantity>(value).getUnit().isEmpty())
	//	std::cout << "1" << std::endl;
    if (value.type() == typeid(double))
        setValue(boost::any_cast<double>(value));
    else if (value.type() == typeid(Quantity)/* && boost::any_cast<Quantity>(value).getUnit().isEmpty()*/)//这里将后半句注释，因为浮点型可以和单位互转
