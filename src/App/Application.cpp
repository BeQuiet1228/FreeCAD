...
void Application::setActiveDocument(Document* pDoc)
{
	...
	Base::Interpreter().runString("FreeCADGui.runCommand('Customize_Activated')");
	/*Gui::Command::doCommand(Gui::Command::Doc, "FreeCADGui.runCommand('Customize_Activated')");*/
}
...
void Application::initTypes(void)
{
	...
	**check box*/
	...
	/*@fubiao*/
	App ::PropertyPolarVector       ::init();
	App ::PropertyCylindricalVector ::init();
	/*end*/
    App ::PropertyVector            ::init();
    App ::PropertyVectorDistance    ::init();
	/*@fubiao*/
	App::PropertyPolVecDistance     ::init();
	App::PropertyCylinderVecDistance::init();
	
	/*end*/
	/*custom property*/
	//App::PropertyCustom             ::init();
	/*end*/
...
void Application::initConfig(int argc, char ** argv)
{
    ...
    if (App::Application::Config().find("BuildVersionMajor") == App::Application::Config().end()) {
        ...
        App::Application::Config()["LoggingFile"] = "1";
#endif
		App::Application::Config()["LoggingFileName"] = mConfig["AppHomePath"]+"bin/logFile.txt";
		App::Application::Config()["FlagReset"] = "false";
    }
