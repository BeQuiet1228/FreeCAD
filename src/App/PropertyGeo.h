 ...
 *极坐标系下的位置属性（r,θ,z）
 */
class AppExport PropertyPolarVector :public Property
{
	TYPESYSTEM_HEADER();
public:
	PropertyPolarVector();
	virtual ~PropertyPolarVector();
	...
	*/
	...
	const char* getEditorName(void) const {
		return "Gui::PropertyEditor::PropertyPolarVectorItem";
	}
...
*极坐标系下的位置属性（r,θ,z）
*/
class AppExport PropertyCylindricalVector :public Property
{
	TYPESYSTEM_HEADER();
public:
	PropertyCylindricalVector();
	virtual ~PropertyCylindricalVector();
	void setValue(const Base::Vector3d &vec);
	void setValue(double x, double y, double z);
	void getPaths(std::vector<ObjectIdentifier> &paths) const;
	...
	*/
	const Base::Vector3d &getValue(void) const;
	const char* getEditorName(void) const {
		return "Gui::PropertyEditor::PropertyCylindricalVectorItem";
	}
...
/*@fubiao*/
class AppExport PropertyPolVecDistance : public PropertyPolarVector
{
	TYPESYSTEM_HEADER();
...
public:
	...
	* A more elaborate description of the destructor.
	*/
	virtual ~PropertyPolVecDistance();

	const boost::any getPathValue(const ObjectIdentifier &path) const;

	const char* getEditorName(void) const {
		return "Gui::PropertyEditor::PropertyPolVecDistanceItem";
	}
};
/*end*/
/*@fubiao*/
class AppExport PropertyCylinderVecDistance : public PropertyCylindricalVector
{
	TYPESYSTEM_HEADER();
...
public:
	...
	* A more elaborate description of the destructor.
	*/
	virtual ~PropertyCylinderVecDistance();

	const boost::any getPathValue(const ObjectIdentifier &path) const;

	const char* getEditorName(void) const {
		return "Gui::PropertyEditor::PropertyCylinderVecDistanceItem";
...
/*custom Property*/
//class AppExport PropertyCustom : public Property
//{
//	TYPESYSTEM_HEADER();
//
//public:
