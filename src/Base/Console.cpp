...
void write_string_to_file_append(const std::string type, const std::string str)
{
	//获得当前程序的路径
	...
	//if (!_file){
	//	std::cout << strPath << " create failed" << std::endl;
	//	_mkdir(strPath.c_str());
	//	//ofstream fout()
	//}
	std::string  file_string = strPath+"\\LOG.txt";
	//std::ofstream fout(file_string);
	//if (fout){
	//	std::cout << file_string << "create successfully" << std::endl;
	//	fout.close();
	//}
	//else{
	//	std::cout << file_string << "cerate failed" << std::endl;
	//	return ;
	//}
	//end
	std::string resultStr = type +"----------------"+ str;
...
PyObject *ConsoleSingleton::sPyWarning(PyObject * /*self*/, PyObject *args, PyObject * /*kwd*/)
{
    ...
    PY_TRY {
		if (string){
			write_string_to_file_append("Warning:", string);
...
PyObject *ConsoleSingleton::sPyError(PyObject * /*self*/, PyObject *args, PyObject * /*kwd*/)
{
    ...
    PY_TRY {
		if (string){
			write_string_to_file_append("Error:", string);
...
PyObject *ConsoleSingleton::sPyLog(PyObject * /*self*/, PyObject *args, PyObject * /*kwd*/)
{
    ...
    PY_TRY {
		if (string){
			write_string_to_file_append("Log:", string);
