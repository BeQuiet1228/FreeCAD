...
/*fubiao*/
Quantity Quantity::NanoMetre(1.0e-9, Unit(1));
Quantity Quantity::MicroMetre(1.0e-6, Unit(1));
Quantity Quantity::MilliMetre(0.001, Unit(1));
Quantity Quantity::CentiMetre(0.01, Unit(1));
Quantity Quantity::DeciMetre(0.1, Unit(1));
Quantity Quantity::Metre(1.0, Unit(1));
Quantity Quantity::KiloMetre(1000.0, Unit(1));
...
Quantity Quantity::MilliSecond(1.0e-3, Unit(0, 0, 1));
...
Quantity Quantity::Volt             (1.0          ,Unit(2,1,-3,-1));  // Volt (kg*m^2/A/s^3)
Quantity Quantity::KiloVolt(1.0e+3, Unit(2, 1, -3, -1));  // Volt (kg*m^2/A/s^3)
Quantity Quantity::MegaVolt(1.0e+6, Unit(2, 1, -3, -1));  // Volt (kg*m^2/A/s^3)

Quantity Quantity::Hertz(1.0, Unit(0, 0, -1));
Quantity Quantity::KiloHertz(1.0e+3, Unit(0, 0, -1));
Quantity Quantity::MegaHertz(1.0e+6, Unit(0, 0, -1));
Quantity Quantity::GigaHertz(1.0e+9, Unit(0, 0, -1));
Quantity Quantity::TeraHertz(1.0e+12, Unit(0, 0, -1));
