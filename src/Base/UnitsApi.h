...
public:
	/*fubiao*/
	static int defaultLengthUnit;
	static int defaultAngleUnit;
	static int defaultTimeSpanUnit;
	static int defaultElectricCurrentUnit;
	static int defaultElectricPotentialUnit;
	static int defaultFrequencyUnit;
	/*end*/
	...
	//设置默认单位
	static void setDefaultUnits(int,int,int,int,int,int);
	static void getDefaultUnits(int &len,int &ang,int &time,int &elecur,int &elepot,int &fre);
	static int getDefaultLength();
	static int getDefaultAngle();
	static int getDefaultTimeSpan();
	static int getDefaultElectricCur();
	static int getDefaultElectircPot();
...
protected: // the python API wrapper methodes
	...
	static PyObject *sSetDefaultUnits(PyObject *self, PyObject *args, PyObject *kwd);
	static PyObject *sGetDefaultUnits(PyObject *self, PyObject *args, PyObject *kwd);
};
