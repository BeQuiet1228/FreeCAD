...
void DlgGeneralImp::saveSettings()
{
    ...
    if (sheet.toString()==QString::fromLatin1("None")) {
...
void DlgGeneralImp::loadSettings()
{
    ...
    //修改“无样式列表”的data部分 @pingyue
    this->StyleSheets->addItem(tr("No style sheet"), QString::fromLatin1("None"));
