...
TaskMonitorWidget_Spacer::TaskMonitorWidget_Spacer(QWidget * parent /* = 0 */, Qt::WindowFlags f /* = 0 */)
    : QWidget(parent, f)
{
    auto widget_spacer_layout = new QHBoxLayout(this);
    widget_spacer_layout->setContentsMargins(0, 0, 0, 0);
    setLayout(widget_spacer_layout);
    auto spacerItem = new QSpacerItem(50, 20, QSizePolicy::Fixed, QSizePolicy::Minimum);//这里的宽度需要设置成与TaskMonitorWidget_2的horizontalLayout的spacing相同
    widget_spacer_layout->addItem(spacerItem);
}

TaskMonitorWidget_File::TaskMonitorWidget_File(ToolBarItem *item, QWidget * parent /* = 0 */, Qt::WindowFlags f /* = 0 */)
    : QWidget(parent, f)
{
    ...
    setObjectName(QString::fromUtf8("ReceiveFileWidget"));
    auto gridLayout = new QGridLayout(this);
    gridLayout->setHorizontalSpacing(0);
    gridLayout->setVerticalSpacing(0);
    gridLayout->setContentsMargins(11, 0, 0, 0);//仅在左边留11个像素的间距
    setLayout(gridLayout);
    for (int i = 0; i < count_items; ++i) {
        QToolButton* toolButton = 0;
        toolButton = mgr.addToGridLayout(items.at(i)->command().c_str(), gridLayout, 0, i);
        // set the tool button user data
        if (toolButton) toolButton->defaultAction()->setData(QString::fromUtf8(items.at(i)->command().c_str()));
    }

    NetStateLabel = new QLabel(parent);
    NetStateLabel->setText(QString::fromUtf8("未连接"));
    NetStateLabel->setAlignment(Qt::AlignLeading | Qt::AlignLeft | Qt::AlignVCenter);
    NetStateLabel->setObjectName(QString::fromUtf8("NetStateLabel"));
    //QFont font(QString::fromUtf8("Microsoft YaHei"), 11);
    //NetStateLabel->setFont(font);
    auto progressWidget = new QWidget(parent);
    auto progressWidgetLayout = new QHBoxLayout(progressWidget);
    progressWidgetLayout->setContentsMargins(-1, -1, 0, -1);//进度条右侧边距设置为0
    NetProgressBar = new QProgressBar(parent);
    NetProgressBar->setFixedSize(QSize(200, 20));
    NetProgressBar->setValue(0);
    NetProgressBar->setObjectName(QString::fromUtf8("NetProgressBar"));
    progressWidgetLayout->addWidget(NetProgressBar);
    gridLayout->addWidget(NetStateLabel, 0, count_items, 1, 1);
    gridLayout->addWidget(progressWidget, 1, 0, 1, count_items + 1);
    for (int i = 0; i < count_items - 1; ++i){
        gridLayout->setColumnStretch(i, 1);
    }
    gridLayout->setColumnStretch(count_items, 1);
    gridLayout->setColumnStretch(count_items + 1, 5);
    gridLayout->setRowStretch(0, 1);
    gridLayout->setRowStretch(1, 1);
}

TaskMonitorWidget_1::TaskMonitorWidget_1(QWidget * parent /* = 0 */, Qt::WindowFlags f /* = 0 */)
    : QWidget(parent, f)
{
    int fixedHeight = getMainWindow()->iconSize().height() + 13;//如果其它工具条中ToolButton大小修改了，这里也要修改
    this->setObjectName(QString::fromUtf8("TaskMonitorWidget1"));
    this->resize(450, 108);
    auto gridLayout = new QGridLayout(this);
    ...
    auto horizontalLayout = new QHBoxLayout(widget_2);
    horizontalLayout->setSpacing(20);
    horizontalLayout->setContentsMargins(0, 0, 0, 0);//去掉默认的11像素间距
    horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
    this->label_iterations = new QLabel(parent);
    this->label_iterations->setText(QString::fromUtf8("迭代次数 (次)"));
    auto sizePolicy = QSizePolicy(QSizePolicy::Preferred, QSizePolicy::Fixed);
    sizePolicy.setHorizontalStretch(0);
    sizePolicy.setVerticalStretch(0);
    sizePolicy.setHeightForWidth(this->label_iterations->sizePolicy().hasHeightForWidth());
    this->label_iterations->setSizePolicy(sizePolicy);
    this->label_iterations->setFixedHeight(fixedHeight);
    this->label_iterations->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
    this->label_iterations->setObjectName(QString::fromUtf8("label_iterations"));
    horizontalLayout->addWidget(this->label_iterations);
    this->iterationResult = new QLabel(parent);
    // this->iterationResult->setText(QString::fromUtf8("(5000)"));
    sizePolicy = QSizePolicy(QSizePolicy::Minimum, QSizePolicy::Expanding);
    sizePolicy.setHorizontalStretch(0);
    sizePolicy.setVerticalStretch(0);
    sizePolicy.setHeightForWidth(this->iterationResult->sizePolicy().hasHeightForWidth());
    this->iterationResult->setSizePolicy(sizePolicy);
    this->iterationResult->setMinimumSize(QSize(60, 0));
    this->iterationResult->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
    this->iterationResult->setObjectName(QString::fromUtf8("iterationResult"));
    //horizontalLayout->addWidget(this->iterationResult);
    //auto spacerItem = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
    //horizontalLayout->addItem(spacerItem);
    gridLayout->addWidget(widget_2, 0, 0, 1, 1);
    auto widget = new QWidget(this);
    widget->setObjectName(QString::fromUtf8("widget"));
    auto horizontalLayout_2 = new QHBoxLayout(widget);
    horizontalLayout_2->setContentsMargins(0, -1, 0, -1);//去掉默认的左右11像素间距
    horizontalLayout_2->setObjectName(QString::fromUtf8("horizontalLayout"));
    this->CalculateProgressBar = new QProgressBar(parent);
    this->CalculateProgressBar->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignBottom);
    this->CalculateProgressBar->setFixedSize(QSize(200, 20));
    this->CalculateProgressBar->setProperty("value", 0);
    this->CalculateProgressBar->setObjectName(QString::fromUtf8("CalculateProgressBar"));
    horizontalLayout_2->addWidget(this->CalculateProgressBar);
    horizontalLayout_2->addWidget(this->iterationResult);
...
TaskMonitorWidget_2::TaskMonitorWidget_2(QWidget * parent /* = 0 */, Qt::WindowFlags f /* = 0 */)
    : QWidget(parent, f)
{
    this->setObjectName(QString::fromUtf8("TaskMonitorWidget2"));
    this->resize(340, 106);
    auto horizontalLayout = new QHBoxLayout(this);
    horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
    horizontalLayout->setSpacing(50); //这里务必与TaskMonitorWidget_Spacer里的宽度相同
    horizontalLayout->setContentsMargins(0, 0, 0, 0);//去掉默认11像素间距
    auto verticalLayout = new QVBoxLayout();
    verticalLayout->setContentsMargins(0, 0, 0, 0);
    verticalLayout->setSpacing(20);
    verticalLayout->setObjectName(QString::fromUtf8("verticalLayout"));
    this->RunningStateText = new QLabel(parent);
    this->RunningStateText->setText(QString::fromUtf8("运行状态"));
    this->RunningStateText->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
    this->RunningStateText->setObjectName(QString::fromUtf8("RunningStateText"));
    verticalLayout->addWidget(this->RunningStateText);
    this->runningStateResult = new QLabel(parent);
    // this->runningStateResult->setText(QString::fromUtf8("(RUNNING)"));
    auto sizePolicy = QSizePolicy(QSizePolicy::Minimum, QSizePolicy::Preferred);
    sizePolicy.setHorizontalStretch(0);
    sizePolicy.setVerticalStretch(0);
    sizePolicy.setHeightForWidth(this->runningStateResult->sizePolicy().hasHeightForWidth());
    this->runningStateResult->setSizePolicy(sizePolicy);
    this->runningStateResult->setMinimumSize(QSize(60, 0));
    this->runningStateResult->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignBottom);
    this->runningStateResult->setObjectName(QString::fromUtf8("runningStateResult"));
    verticalLayout->addWidget(this->runningStateResult);
    horizontalLayout->addLayout(verticalLayout);
    auto verticalLayout_2 = new QVBoxLayout();
    verticalLayout_2->setContentsMargins(0, 0, 0, 0);
    verticalLayout_2->setSpacing(20);
    verticalLayout_2->setObjectName(QString::fromUtf8("verticalLayout_2"));
    this->label_consumingTime = new QLabel(parent);
    this->label_consumingTime->setText(QString::fromUtf8("消耗时间"));
    this->label_consumingTime->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
    this->label_consumingTime->setObjectName(QString::fromUtf8("label_consumingTime"));
    verticalLayout_2->addWidget(this->label_consumingTime);
    this->consumingTimeResult = new QLabel(parent);
    // this->consumingTimeResult->setText(QString::fromUtf8("(2:18:26:05)"));
    sizePolicy = QSizePolicy(QSizePolicy::Minimum, QSizePolicy::Preferred);
    sizePolicy.setHorizontalStretch(0);
    sizePolicy.setVerticalStretch(0);
    sizePolicy.setHeightForWidth(this->consumingTimeResult->sizePolicy().hasHeightForWidth());
    this->consumingTimeResult->setSizePolicy(sizePolicy);
    this->consumingTimeResult->setMinimumSize(QSize(60, 0));
    this->consumingTimeResult->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignBottom);
    this->consumingTimeResult->setObjectName(QString::fromUtf8("consumingTimeResult"));
    verticalLayout_2->addWidget(this->consumingTimeResult);
    ...
    this->label_iteration_time = new QLabel(parent);
    this->label_iteration_time->setText(QString::fromUtf8("迭代时间 (纳秒)"));
    this->label_iteration_time->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
    this->label_iteration_time->setObjectName(QString::fromUtf8("label_iteration_time"));
    verticalLayout_3->addWidget(this->label_iteration_time);
    this->iterationTimeResult = new QLabel(parent);
    // this->iterationTimeResult->setText(QString::fromUtf8("(600000)"));
    sizePolicy.setHorizontalStretch(0);
    sizePolicy.setVerticalStretch(0);
    sizePolicy.setHeightForWidth(this->iterationTimeResult->sizePolicy().hasHeightForWidth());
    this->iterationTimeResult->setSizePolicy(sizePolicy);
    this->iterationTimeResult->setMinimumSize(QSize(60, 0));
    this->iterationTimeResult->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignBottom);
    this->iterationTimeResult->setObjectName(QString::fromUtf8("iterationTimeResult"));
    verticalLayout_3->addWidget(this->iterationTimeResult);
    horizontalLayout->addLayout(verticalLayout_3);
    auto verticalLayout_4 = new QVBoxLayout();
    verticalLayout_4->setContentsMargins(0, 0, 0, 0);
    verticalLayout_4->setSpacing(20);
    verticalLayout_4->setObjectName(QString::fromUtf8("verticalLayout_4"));
    this->label_particleNumber = new QLabel(parent);
    this->label_particleNumber->setText(QString::fromUtf8("粒子数目 (个)"));
    this->label_particleNumber->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
    this->label_particleNumber->setObjectName(QString::fromUtf8("label_particleNumber"));
    verticalLayout_4->addWidget(this->label_particleNumber);
    this->particelNumberResult = new QLabel(parent);
    // this->particelNumberResult->setText(QString::fromUtf8("(100000000)"));
    sizePolicy = QSizePolicy(QSizePolicy::Minimum, QSizePolicy::Preferred);
    sizePolicy.setHorizontalStretch(0);
    sizePolicy.setVerticalStretch(0);
    sizePolicy.setHeightForWidth(this->particelNumberResult->sizePolicy().hasHeightForWidth());
    this->particelNumberResult->setSizePolicy(sizePolicy);
    this->particelNumberResult->setMinimumSize(QSize(60, 0));
    this->particelNumberResult->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignBottom);
    this->particelNumberResult->setObjectName(QString::fromUtf8("particelNumberResult"));
    verticalLayout_4->addWidget(this->particelNumberResult);
    horizontalLayout->addLayout(verticalLayout_4);

    this->setLayout(horizontalLayout);
}

TaskMonitorWidget_3::TaskMonitorWidget_3(QWidget * parent /* = 0 */, Qt::WindowFlags f /* = 0 */)
    : QWidget(parent, f)
{
    this->setObjectName(QString::fromUtf8("TaskMonitorWidget3"));
    this->resize(390, 106);
    auto horizontalLayout = new QHBoxLayout(this);
    horizontalLayout->setObjectName(QString::fromUtf8("horizontalLayout"));
    auto verticalLayout_3 = new QVBoxLayout();
    ...
    verticalLayout_3->addWidget(this->iterationTimeResult);
    horizontalLayout->addLayout(verticalLayout_3);
    auto verticalLayout_3_2 = new QVBoxLayout();
    verticalLayout_3_2->setSpacing(20);
    verticalLayout_3_2->setObjectName(QString::fromUtf8("verticalLayout_3_2"));
    this->label_particleNumber = new QLabel(parent);
    this->label_particleNumber->setText(QString::fromUtf8("粒子数目 (个)"));
    this->label_particleNumber->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignVCenter);
    this->label_particleNumber->setObjectName(QString::fromUtf8("label_particleNumber"));
    verticalLayout_3_2->addWidget(this->label_particleNumber);
    this->particelNumberResult = new QLabel(parent);
    // this->particelNumberResult->setText(QString::fromUtf8("(100000000)"));
    sizePolicy = QSizePolicy(QSizePolicy::Minimum, QSizePolicy::Preferred);
    sizePolicy.setHorizontalStretch(0);
    ...
    this->particelNumberResult->setAlignment(Qt::AlignLeading|Qt::AlignLeft|Qt::AlignBottom);
    this->particelNumberResult->setObjectName(QString::fromUtf8("particelNumberResult"));
    verticalLayout_3_2->addWidget(this->particelNumberResult);
    horizontalLayout->addLayout(verticalLayout_3_2);
