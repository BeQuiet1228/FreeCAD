...
void TaskCSysDragger::setupGui()
{
  ...
  /*fubiao*/
  Gui::TaskView::TaskBox *incrementsBoxMy = new Gui::TaskView::TaskBox(
	  Gui::BitmapFactory().pixmap("button_valid"),
	  tr("NonUniformGrid"), true, 0);
  QGridLayout *gridLayoutMy = new QGridLayout();
  gridLayoutMy->setColumnStretch(2, 2);
 
  QRadioButton *radioBtnX = new QRadioButton(incrementsBoxMy);
  radioBtnX->setObjectName(tr("radioBtnX"));
  
  QRadioButton *radioBtnY = new QRadioButton(incrementsBoxMy);
  radioBtnY->setObjectName(tr("radioBtnY"));
  
  QRadioButton *radioBtnZ = new QRadioButton(incrementsBoxMy);
  radioBtnZ->setObjectName(tr("radioBtnZ"));
  
  gridLayoutMy->addWidget(radioBtnX, 0, 0, Qt::AlignRight);
  gridLayoutMy->addWidget(radioBtnY, 0, 1, Qt::AlignRight);
  gridLayoutMy->addWidget(radioBtnZ, 0, 2, Qt::AlignRight);
  incrementsBoxMy->groupLayout()->addLayout(gridLayoutMy);
  Content.push_back(incrementsBoxMy);
  /*end*/
}
