...
public:
    StyledComboBox(QWidget *parent = 0);
};

class TaskMonitorWidget_Spacer : public QWidget
{
    Q_OBJECT
private:
...
public:
    TaskMonitorWidget_Spacer(QWidget * parent = 0, Qt::WindowFlags f = 0);
};

class TaskMonitorWidget_File : public QWidget
{
    Q_OBJECT
private:
    QLabel *NetStateLabel;
    QProgressBar *NetProgressBar;
public:
    TaskMonitorWidget_File(ToolBarItem *item, QWidget * parent = 0, Qt::WindowFlags f = 0);
};

class TaskMonitorWidget_1 : public QWidget
{
    Q_OBJECT

private:
    QLabel *label_iterations;
    QLabel *iterationResult;
    QProgressBar *CalculateProgressBar;
public:
    TaskMonitorWidget_1(QWidget * parent = 0, Qt::WindowFlags f = 0);
};

class TaskMonitorWidget_2 : public QWidget
{
    Q_OBJECT

private:
    QLabel *RunningStateText;
    QLabel *runningStateResult;
    QLabel *label_consumingTime;
    QLabel *consumingTimeResult;
    QLabel *label_iteration_time;
    QLabel *iterationTimeResult;
    QLabel *label_particleNumber;
    QLabel *particelNumberResult;
public:
    TaskMonitorWidget_2(QWidget * parent = 0, Qt::WindowFlags f = 0);
};

//已合并到Widget_2，不再使用
class TaskMonitorWidget_3 : public QWidget
{
    Q_OBJECT
...
private:
    ...
    QLabel *particelNumberResult;
public:
    TaskMonitorWidget_3(QWidget * parent = 0, Qt::WindowFlags f = 0);
};

//Workbench工具条，主要是方便在QSS中设置样式
class WorkbenchToolBar : public QToolBar
{
    Q_OBJECT
public:
    WorkbenchToolBar(QWidget *parent) : QToolBar(parent) {};
    WorkbenchToolBar(const QString &title, QWidget *parent) : QToolBar(title, parent) {};
};
