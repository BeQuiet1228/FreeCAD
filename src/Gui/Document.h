...
typedef struct BooleanObjects{
	int order;
	App::DocumentObject* lastResultObj;
	std::vector<App::Color> lastDiffuseCol;
	float lastTransparency;
	//Gui::ViewProvider* lastVp;
	App::DocumentObject* curResultObj;
	std::vector<App::Color> curDiffuseCol;
	float curTransparency;

	BooleanObjects&operator=(const BooleanObjects& bo){
		this->order = bo.order;
		this->lastResultObj = bo.lastResultObj;
		this->lastDiffuseCol = bo.lastDiffuseCol;
		this->lastTransparency = bo.lastTransparency;
		this->curResultObj = bo.curResultObj;
		this->curDiffuseCol = bo.curDiffuseCol;
		this->curTransparency = bo.curTransparency;
		return *this;
	}
}booleanObject;
/** The Gui Document
