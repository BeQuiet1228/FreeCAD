...
public:
    ...
    void addTo(QWidget *);
    void insertTo(QWidget *, QAction *);
    QToolButton* addToGridLayout(QGridLayout *, int, int, int, int);
...
public:
    ...
    /// added by pingyue : adds this command to a given gridlayout
    QToolButton* addToGridLayout(const char* Name, QGridLayout* pcGridLayout, int row, int col, int rowStretch = 1, int colStretch = 1);
