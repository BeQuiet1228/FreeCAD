...
{
    StyledComboBox *cb = new StyledComboBox(parent);
    cb->setFrame(false);
...
{
    StyledComboBox *cb = qobject_cast<StyledComboBox*>(editor);
    QFontDatabase fdb;
...
// ---------------------------------------------------------------
/*@fubiao*/
PROPERTYITEM_SOURCE(Gui::PropertyEditor::PropertyPolarVectorItem)

PropertyPolarVectorItem::PropertyPolarVectorItem()
{
	m_x = static_cast<PropertyFloatItem*>(PropertyFloatItem::create());
	m_x->setParent(this);
	m_x->setPropertyName(QLatin1String("r"));
	this->appendChild(m_x);
	m_y = static_cast<PropertyFloatItem*>(PropertyAngleItem::create());
	//m_y = static_cast<PropertyUnitItem*>(PropertyAngleItem::create());
	m_y->setParent(this);
	m_y->setPropertyName(QLatin1String("theta"));
...
QVariant PropertyPolarVectorItem::toString(const QVariant& prop) const
{
...
QVariant PropertyPolarVectorItem::value(const App::Property* prop) const
{
	assert(prop && prop->getTypeId().isDerivedFrom(App::PropertyPolarVector::getClassTypeId()));

	const Base::Vector3d& value = static_cast<const App::PropertyPolarVector*>(prop)->getValue();
	return QVariant::fromValue<Base::Vector3d>(value);
}

void PropertyPolarVectorItem::setValue(const QVariant& value)
{
...
QWidget* PropertyPolarVectorItem::createEditor(QWidget* parent, const QObject* /*receiver*/, const char* /*method*/) const
{
	QLineEdit *le = new QLineEdit(parent);
	le->setFrame(false);
	le->setReadOnly(true);
...
void PropertyPolarVectorItem::setEditorData(QWidget *editor, const QVariant& data) const
{
	QLineEdit* le = qobject_cast<QLineEdit*>(editor);
...
QVariant PropertyPolarVectorItem::editorData(QWidget *editor) const
{
	QLineEdit *le = qobject_cast<QLineEdit*>(editor);
	return QVariant(le->text());
}

double PropertyPolarVectorItem::x() const
{
	return data(1, Qt::EditRole).value<Base::Vector3d>().x;
	//return 0.5;
}

void PropertyPolarVectorItem::setX(double x)
{
	setData(QVariant::fromValue(Base::Vector3d(x, y(), z())));
}

double PropertyPolarVectorItem::y() const
{
	return data(1, Qt::EditRole).value<Base::Vector3d>().y;
}

void PropertyPolarVectorItem::setY(double y)
{
	setData(QVariant::fromValue(Base::Vector3d(x(), y, z())));
}

double PropertyPolarVectorItem::z() const
{
	return data(1, Qt::EditRole).value<Base::Vector3d>().z;
}

void PropertyPolarVectorItem::setZ(double z)
{
	setData(QVariant::fromValue(Base::Vector3d(x(), y(), z)));
}

void PropertyPolarVectorItem::propertyBound() {
...
// ---------------------------------------------------------------
/*@fubiao*/
PROPERTYITEM_SOURCE(Gui::PropertyEditor::PropertyCylindricalVectorItem)

PropertyCylindricalVectorItem::PropertyCylindricalVectorItem()
{
	m_z = static_cast<PropertyFloatItem*>(PropertyFloatItem::create());
	m_z->setParent(this);
	m_z->setPropertyName(QLatin1String("z"));
...
QVariant PropertyCylindricalVectorItem::toString(const QVariant& prop) const
{
	const Base::Vector3d& value = prop.value<Base::Vector3d>();
	QString data = QString::fromLatin1("[%1 %2 %3]")
		.arg(QLocale::system().toString(value.x, 'f', 2))
...
QVariant PropertyCylindricalVectorItem::value(const App::Property* prop) const
{
	assert(prop && prop->getTypeId().isDerivedFrom(App::PropertyCylindricalVector::getClassTypeId()));

	const Base::Vector3d& value = static_cast<const App::PropertyCylindricalVector*>(prop)->getValue();
	return QVariant::fromValue<Base::Vector3d>(value);
}

void PropertyCylindricalVectorItem::setValue(const QVariant& value)
{
	if (!value.canConvert<Base::Vector3d>())
		return;
	const Base::Vector3d& val = value.value<Base::Vector3d>();
...
QWidget* PropertyCylindricalVectorItem::createEditor(QWidget* parent, const QObject* /*receiver*/, const char* /*method*/) const
{
	QLineEdit *le = new QLineEdit(parent);
	le->setFrame(false);
	le->setReadOnly(true);
...
void PropertyCylindricalVectorItem::setEditorData(QWidget *editor, const QVariant& data) const
{
	QLineEdit* le = qobject_cast<QLineEdit*>(editor);
	const Base::Vector3d& value = data.value<Base::Vector3d>();
	QString text = QString::fromLatin1("[%1 %2 %3]")
...
QVariant PropertyCylindricalVectorItem::editorData(QWidget *editor) const
{
	QLineEdit *le = qobject_cast<QLineEdit*>(editor);
	return QVariant(le->text());
}

double PropertyCylindricalVectorItem::x() const
{
	return data(1, Qt::EditRole).value<Base::Vector3d>().x;
	//return 0.5;
}

void PropertyCylindricalVectorItem::setX(double x)
{
	setData(QVariant::fromValue(Base::Vector3d(x, y(), z())));
}

double PropertyCylindricalVectorItem::y() const
{
	return data(1, Qt::EditRole).value<Base::Vector3d>().y;
}

void PropertyCylindricalVectorItem::setY(double y)
{
	setData(QVariant::fromValue(Base::Vector3d(x(), y, z())));
}

double PropertyCylindricalVectorItem::z() const
{
	return data(1, Qt::EditRole).value<Base::Vector3d>().z;
}

void PropertyCylindricalVectorItem::setZ(double z)
{
	setData(QVariant::fromValue(Base::Vector3d(x(), y(), z)));
}

void PropertyCylindricalVectorItem::propertyBound() {
...
PropertyVectorItem::PropertyVectorItem()
{
    ...
    this->appendChild(m_x);
	/*test*/
	//this->takeChild(0)->setReadOnly(true);
	/*end*/
...
/*fubiao*/
QVariant PropertyVectorItem::Point(const App::Property* prop) const
{
...
void PropertyVectorItem::setPoint(const QVariant& value)
{
...
PROPERTYITEM_SOURCE(Gui::PropertyEditor::PropertyPolVecDistanceItem)

PropertyPolVecDistanceItem::PropertyPolVecDistanceItem()
{
	m_x = static_cast<PropertyUnitItem*>(PropertyUnitItem::create());
	m_x->setParent(this);
	m_x->setPropertyName(QLatin1String("r"));
...
QVariant PropertyPolVecDistanceItem::toString(const QVariant& prop) const
{
	const Base::Vector3d& value = prop.value<Base::Vector3d>();
	QString data = QString::fromLatin1("[") +
		Base::Quantity(value.x, Base::Unit::Length).getUserString() + QString::fromLatin1("  ") +
		Base::Quantity(value.y, Base::Unit::Angle).getUserString() + QString::fromLatin1("  ") +
		Base::Quantity(value.z, Base::Unit::Length).getUserString() + QString::fromLatin1("]");
	return QVariant(data);
}


QVariant PropertyPolVecDistanceItem::value(const App::Property* prop) const
{
	assert(prop && prop->getTypeId().isDerivedFrom(App::PropertyPolarVector::getClassTypeId()));
...
void PropertyPolVecDistanceItem::setValue(const QVariant& variant)
{
	if (!variant.canConvert<Base::Vector3d>())
		return;
	const Base::Vector3d& value = variant.value<Base::Vector3d>();
	...
	Base::Quantity x = Base::Quantity(value.x, Base::Unit::Length);
	Base::Quantity y = Base::Quantity(value.y, Base::Unit::Angle);
	Base::Quantity z = Base::Quantity(value.z, Base::Unit::Length);
	QString data = QString::fromLatin1("(%1, %2, %3)")
		.arg(x.getValue())
		.arg(y.getValue())
...
void PropertyPolVecDistanceItem::setEditorData(QWidget *editor, const QVariant& data) const
{
	QLineEdit* le = qobject_cast<QLineEdit*>(editor);
	le->setText(toString(data).toString());
}

QWidget* PropertyPolVecDistanceItem::createEditor(QWidget* parent, const QObject* /*receiver*/, const char* /*method*/) const
{
	QLineEdit *le = new QLineEdit(parent);
	le->setFrame(false);
	le->setReadOnly(true);
...
QVariant PropertyPolVecDistanceItem::editorData(QWidget *editor) const
{
	QLineEdit *le = qobject_cast<QLineEdit*>(editor);
	return QVariant(le->text());
}

Base::Quantity PropertyPolVecDistanceItem::x() const
{
	return Base::Quantity(data(1, Qt::EditRole).value<Base::Vector3d>().x, Base::Unit::Length);
}

void PropertyPolVecDistanceItem::setX(Base::Quantity x)
{
	setData(QVariant::fromValue(Base::Vector3d(x.getValue(), y().getValue(), z().getValue())));
}

Base::Quantity PropertyPolVecDistanceItem::y() const
{
	return Base::Quantity(data(1, Qt::EditRole).value<Base::Vector3d>().y, Base::Unit::Angle);
}

void PropertyPolVecDistanceItem::setY(Base::Quantity y)
{
	setData(QVariant::fromValue(Base::Vector3d(x().getValue(), y.getValue(), z().getValue())));
}

Base::Quantity PropertyPolVecDistanceItem::z() const
{
	return Base::Quantity(data(1, Qt::EditRole).value<Base::Vector3d>().z, Base::Unit::Length);
}

void PropertyPolVecDistanceItem::setZ(Base::Quantity z)
{
	setData(QVariant::fromValue(Base::Vector3d(x().getValue(), y().getValue(), z.getValue())));
}

void PropertyPolVecDistanceItem::propertyBound() {

	if (isBound()) {
		m_x->bind(App::ObjectIdentifier(getPath()) << App::ObjectIdentifier::String("x"));
		m_y->bind(App::ObjectIdentifier(getPath()) << App::ObjectIdentifier::String("y"));
		//m_y->bind(App::ObjectIdentifier(getPath()) << App::ObjectIdentifier::String("Rotation")
...
PROPERTYITEM_SOURCE(Gui::PropertyEditor::PropertyCylinderVecDistanceItem)

PropertyCylinderVecDistanceItem::PropertyCylinderVecDistanceItem()
{
	m_z = static_cast<PropertyUnitItem*>(PropertyUnitItem::create());
	m_z->setParent(this);
	m_z->setPropertyName(QLatin1String("z"));
...
QVariant PropertyCylinderVecDistanceItem::toString(const QVariant& prop) const
{
	const Base::Vector3d& value = prop.value<Base::Vector3d>();
	QString data = QString::fromLatin1("[") +
		Base::Quantity(value.z, Base::Unit::Length).getUserString() + QString::fromLatin1("  ") +
...
QVariant PropertyCylinderVecDistanceItem::value(const App::Property* prop) const
{
	assert(prop && prop->getTypeId().isDerivedFrom(App::PropertyCylindricalVector::getClassTypeId()));
...
void PropertyCylinderVecDistanceItem::setValue(const QVariant& variant)
{
	if (!variant.canConvert<Base::Vector3d>())
		return;
	const Base::Vector3d& value = variant.value<Base::Vector3d>();
...
void PropertyCylinderVecDistanceItem::setEditorData(QWidget *editor, const QVariant& data) const
{
	QLineEdit* le = qobject_cast<QLineEdit*>(editor);
	le->setText(toString(data).toString());
}

QWidget* PropertyCylinderVecDistanceItem::createEditor(QWidget* parent, const QObject* /*receiver*/, const char* /*method*/) const
{
	QLineEdit *le = new QLineEdit(parent);
	le->setFrame(false);
	le->setReadOnly(true);
...
QVariant PropertyCylinderVecDistanceItem::editorData(QWidget *editor) const
{
	QLineEdit *le = qobject_cast<QLineEdit*>(editor);
	return QVariant(le->text());
}

Base::Quantity PropertyCylinderVecDistanceItem::x() const
{
	return Base::Quantity(data(1, Qt::EditRole).value<Base::Vector3d>().x, Base::Unit::Length);
}

void PropertyCylinderVecDistanceItem::setX(Base::Quantity x)
{
	setData(QVariant::fromValue(Base::Vector3d(x.getValue(), y().getValue(), z().getValue())));
}

Base::Quantity PropertyCylinderVecDistanceItem::y() const
{
	return Base::Quantity(data(1, Qt::EditRole).value<Base::Vector3d>().y, Base::Unit::Angle);
}

void PropertyCylinderVecDistanceItem::setY(Base::Quantity y)
{
	setData(QVariant::fromValue(Base::Vector3d(x().getValue(), y.getValue(), z().getValue())));
}

Base::Quantity PropertyCylinderVecDistanceItem::z() const
{
	return Base::Quantity(data(1, Qt::EditRole).value<Base::Vector3d>().z, Base::Unit::Length);
}

void PropertyCylinderVecDistanceItem::setZ(Base::Quantity z)
{
	setData(QVariant::fromValue(Base::Vector3d(x().getValue(), y().getValue(), z.getValue())));
}

void PropertyCylinderVecDistanceItem::propertyBound() {
...
PropertyPlacementItem::PropertyPlacementItem() : init_axis(false), changed_value(false), rot_angle(0), rot_axis(0,0,1)
{
	...
	/*fubioa 测试 改为false*/
	m_d->setReadOnly(false);
	//Base::Console.Message("Axis:%s",m_d->getContainer()->isReadOnly(m_d) ? "true" : "false");
	/*end*/
...
//PROPERTYITEM_SOURCE(Gui::PropertyEditor::PropertyCheckBoxItem)
//
//PropertyCheckBoxItem::PropertyCheckBoxItem()
//{
//}
//
//QVariant PropertyCheckBoxItem::value(const App::Property* prop) const
//{
//	assert(prop && prop->getTypeId().isDerivedFrom(App::PropertyCheckBox::getClassTypeId()));
//
//	const App::PropertyCheckBox* prop_enum = static_cast<const App::PropertyCheckBox*>(prop);
//	const std::vector<std::string>& value = prop_enum->getEnumVector();
//	long currentItem = prop_enum->getValue();
//
//	if (currentItem < 0 || currentItem >= static_cast<long>(value.size()))
...
//}
//
//void PropertyCheckBoxItem::setValue(const QVariant& value)
//{
//	if (!value.canConvert(QVariant::StringList))
//		return;
//	QStringList items = value.toStringList();
...
//}
//
//QWidget* PropertyCheckBoxItem::createEditor(QWidget* parent, const QObject* receiver, const char* method) const
//{
//	/*StyledComboBox *cb = new StyledComboBox(parent);
//	cb->setFrame(false);
//	cb->setDisabled(isReadOnly());
...
//	cd->setFrame(false);
//	cd->setDisabled(isReadOnly());
//	QObject::connect(cb, SIGNAL(activated(int)), receiver, method);
//	return cb;
//}
//
//void PropertyCheckBoxItem::setEditorData(QWidget *editor, const QVariant& data) const
//{
//	const std::vector<App::Property*>& items = getPropertyData();
//
//	QStringList commonModes, modes;
//	for (std::vector<App::Property*>::const_iterator it = items.begin(); it != items.end(); ++it) {
//		if ((*it)->getTypeId() == App::PropertyCheckBox::getClassTypeId()) {
//			App::PropertyCheckBox* prop = static_cast<App::PropertyCheckBox*>(*it);
//			if (prop->getEnums() == 0) {
//				commonModes.clear();
//				break;
//			}
...
//}
//
//QVariant PropertyCheckBoxItem::editorData(QWidget *editor) const
//{
//	StyledComboBox *cb = qobject_cast<StyledComboBox*>(editor);
//	return QVariant(cb->currentText());
//}
