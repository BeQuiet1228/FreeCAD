...
/*PropertyPolarVectorItem
*@fubiao
**/
class PropertyFloatItem;
class GuiExport PropertyPolarVectorItem : public PropertyItem
{
	Q_OBJECT
	Q_PROPERTY(double r READ x WRITE setX DESIGNABLE true USER true)
	Q_PROPERTY(double theta READ y WRITE setY DESIGNABLE true USER true)
...
/*PropertyCylindricalVectorItem
*@fubiao
**/
class PropertyFloatItem;
class GuiExport PropertyCylindricalVectorItem : public PropertyItem
{
	Q_OBJECT
	Q_PROPERTY(double r READ x WRITE setX DESIGNABLE true USER true)
	Q_PROPERTY(double theta READ y WRITE setY DESIGNABLE true USER true)
...
class GuiExport PropertyVectorItem: public PropertyItem
{
    ...
    Q_PROPERTY(double z READ z WRITE setZ DESIGNABLE true USER true)
	/*fubiao*/
	//Q_PROPERTY(QVariant Point READ Point WRITE setPoint DESIGNABLE true USER true)
    PROPERTYITEM_HEADER
...
protected:
	/*fubiao*/
	virtual QVariant Point(const App::Property*) const;
	virtual void setPoint(const QVariant&);
	/*end*/
    virtual QVariant toString(const QVariant&) const;
    virtual QVariant value(const App::Property*) const;
    virtual void setValue(const QVariant&);
...
/*@fubiao*/
class PropertyUnitItem;
class GuiExport PropertyPolVecDistanceItem : public PropertyItem
{
	Q_OBJECT
	Q_PROPERTY(Base::Quantity r READ x WRITE setX DESIGNABLE true USER true)
	Q_PROPERTY(Base::Quantity theta READ y WRITE setY DESIGNABLE true USER true)
	Q_PROPERTY(Base::Quantity z READ z WRITE setZ DESIGNABLE true USER true)
	PROPERTYITEM_HEADER
...
/*@fubiao*/
class PropertyUnitItem;
class GuiExport PropertyCylinderVecDistanceItem : public PropertyItem
{
	Q_OBJECT
	Q_PROPERTY(Base::Quantity r READ x WRITE setX DESIGNABLE true USER true)
	Q_PROPERTY(Base::Quantity theta READ y WRITE setY DESIGNABLE true USER true)
...
protected:
	...
	PropertyCylinderVecDistanceItem();
...
/*@fubiao
**CheckBox*/
//class GuiExport PropertyCheckBoxItem : public PropertyItem
//{
//	Q_OBJECT
//	PROPERTYITEM_HEADER
//
