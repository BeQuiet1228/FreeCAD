...
/*fubiao*/
template<class T> struct DisableCompare : public std::binary_function<T, T, bool>
{
...
void PropertyModel::buildUp(const PropertyModel::PropertyList& props)
{
	...
	//std::map<std::string, std::vector<std::vector<App::Property*>>, DisableCompare<std::string>> propGroup;
	//std::vector<std::vector<std::vector<App::Property*>>> propGroup;
	...
	std::map<std::string, std::vector<std::vector<App::Property*>>> ::const_iterator kt;
	//std::vector< std::vector<std::vector<App::Property*>>> ::const_iterator kt;
...
/*fubiao*/
void reorderProperty(const App::Property&, int upOrDown){
