...
protected:
    ...
    void setup_one_line(ToolBarItem*, QToolBar*) const;
    void setup_multiple_groups(ToolBarItem*, QToolBar*) const;
    void setup_taskMonitorToolBar(ToolBarItem* item, QToolBar* toolbar) const;
