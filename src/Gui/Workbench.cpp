...
MenuItem* StdWorkbench::setupMenuBar() const
{
    ...
    *file << "Std_New" << "Std_Open" << "Separator" << "Std_CloseActiveWindow"
          ...
          << "Separator" << "Std_RecentFiles" << "Separator" << "Std_Quit"<<"Std_IPConfig";
    ...
    *wnd << "Std_ActivateNextWindow" << "Std_ActivatePrevWindow" << "Separator"
	...
	//删除help不需要的部分 delete by chenjian
	...
	*help << "Std_OnlineHelp" << "Std_About"<<"Std_Example";
...
ToolBarItem* StdWorkbench::setupToolBars() const
{
	...
	//公用工具栏部分删除不需要按钮 delete by chenjian ----start
	...
	*run << "Std_Run_M3d" << "Std_Paralle_Run" << "Std_Smart_Contrl" << "Std_Connect_Way" << "Std_Open_Log"<<"Std_Smart_Calc"
        <<"Std_Genetic_Algorithm" << "Std_Multiple_TargetGenetic_Algorithm" << "Std_Multiple_TargetGenetic_Algorithm_G";
...
/*	ToolBarItem* projectSetting = new ToolBarItem(root);
    ...
    *macro << "Std_DlgMacroRecord" << "Std_MacroStopRecord" << "Std_DlgMacroExecute"
	...
	//公用工具栏部分删除不需要按钮 by chenjian ----end 
...
DockWindowItems* StdWorkbench::setupDockWindows() const
{
    ...
    root->addDockWidget("Std_TreeView", Qt::LeftDockWidgetArea, false, false);
...
MenuItem* NoneWorkbench::setupMenuBar() const
{
    ...
    *view << "Std_Workbench";
    ...
    MenuItem* help = new MenuItem( menuBar );
    help->setCommand("&Help");
	*help << "Std_OnlineHelp" << "Std_About" << "Std_AboutQt" << "Std_Example";
