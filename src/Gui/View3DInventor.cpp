...
void View3DInventor::OnChange(ParameterGrp::SubjectType &rCaller,ParameterGrp::MessageType Reason)
{
    ...
    if (strcmp(Reason,"HeadlightColor") == 0) {
        ...
        //修改了3D视图的默认背景颜色 @pingyue
        unsigned long col1 = rGrp.GetUnsigned("BackgroundColor",1385087488UL);
        unsigned long col2 = rGrp.GetUnsigned("BackgroundColor2",3134384640UL); // default color (dark blue)
        unsigned long col3 = rGrp.GetUnsigned("BackgroundColor3",1385087488UL); // default color (blue/grey)
        unsigned long col4 = rGrp.GetUnsigned("BackgroundColor4",2259736064UL); // default color (blue/grey)
